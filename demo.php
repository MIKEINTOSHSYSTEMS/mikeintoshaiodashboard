...
<head>
    <meta charset="UTF-8">
    <title>DEMO | Dereja - M&E - System</title>
            ...
            <div class="sidebar-menu">
                ...
                <li class="item" id="employment_reports">
                    <a href="#employment_reports" class="menu-btn">
                        <i class="fas fa-briefcase"></i><span>Employment<i
            ...
            <div class="header-menu">
                ...
                <ul>
                    <ul>
                        ...
                        <span
                            onClick="changeIframe('https://derejademo.merqconsultancy.org/auth/login?redirect=%2F',this)"
                            class="parentCatagory">
                            <p class="subButtons">
                                <!-- cnd:] -->
