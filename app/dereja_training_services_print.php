...
require_once("include/dereja_training_services_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dereja_training_services" );
