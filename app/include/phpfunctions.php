...
$value.="<span data-column='likecount' class='yes btn btn-success fa fa-thumbs-up'> Yes (<i>".$data["likecount"]."</i>)</span>";
$value.="<span data-column='dislikecount' class='no btn btn-warning fa fa-thumbs-down'> No (<i>".$data["dislikecount"]."</i>)</span>";
$value.="<span class='feedback fa btn btn-primary fa-comment'> Add Comment</span>";
$value.="</span>";
$value.="<span class='thankyou'> Thank you!</span>";;
		return $value;
	}
