...
$dalTableindicator_targets["IndicatorValue"] = array("type"=>200,"varname"=>"IndicatorValue", "name" => "IndicatorValue", "autoInc" => "0");
$dalTableindicator_targets["IndicatorTarget"] = array("type"=>200,"varname"=>"IndicatorTarget", "name" => "IndicatorTarget", "autoInc" => "0");
