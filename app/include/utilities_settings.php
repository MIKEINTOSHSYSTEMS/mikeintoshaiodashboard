...
$tdatautilities[".pagesByType"] = my_json_decode( "{\"list\":[\"list\",\"Career_Compass_Assessments\",\"Career_Compass_Submissions\",\"Chat\",\"Form_Submissions\",\"Project_Manager\",\"Survey\",\"Survey_Forms\",\"document_manager\",\"knowledge_base\",\"merq_ai_data_assistant\"],\"print\":[\"print\"],\"search\":[\"search\"]}" );
$tdatautilities[".originalPagesByType"] = $tdatautilities[".pagesByType"];
$tdatautilities[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\",\"Career_Compass_Assessments\",\"Career_Compass_Submissions\",\"Chat\",\"Form_Submissions\",\"Project_Manager\",\"Survey\",\"Survey_Forms\",\"document_manager\",\"knowledge_base\",\"merq_ai_data_assistant\"],\"print\":[\"print\"],\"search\":[\"search\"]}" ) );
