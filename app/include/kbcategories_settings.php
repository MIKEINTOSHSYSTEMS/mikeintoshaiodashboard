...
$tdatakbcategories[".pagesByType"] = my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatakbcategories[".originalPagesByType"] = $tdatakbcategories[".pagesByType"];
$tdatakbcategories[".pages"] = types2pages( my_json_decode( "{\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatakbcategories[".originalPages"] = $tdatakbcategories[".pages"];
$tdatakbcategories[".defaultPages"] = my_json_decode( "{\"list\":\"list\",\"search\":\"search\",\"view\":\"view\"}" );
...
$tdatakbcategories[".connId"] = "deredevatderejadevmerqconsulta";
...
//	kbarticles
	...
	$detailsParam["dDataSourceTable"]="kbarticles";
		$detailsParam["dOriginalTable"] = "kbarticles";
...
$proto14["m_link"] = "SQLL_MAIN";
			$proto15=array();
$proto15["m_strName"] = "kbcategories";
