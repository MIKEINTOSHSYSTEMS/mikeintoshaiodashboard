...
function getMenuNodes_DerejaMenuSet($menuNodesObject)
{
	...
	$menuNode = array();
	$menuNode["id"] = "89";
	$menuNode["name"] = "Employment-Status";
	$menuNode["href"] = "mypage.htm";
	$menuNode["type"] = "Leaf";
	...
	$menuNode["icon"] = "fa-sliders";
	$menuNode["iconType"] = "3";
	$menuNode["iconShow"] = "1";

		$menuNode["color"] = "";

	$menuNode["title"] = "Fields Setting";
	...
	$menuNode = array();
	$menuNode["id"] = "134";
	$menuNode["name"] = "Custom Candicate Fields";
	$menuNode["href"] = "";
	$menuNode["type"] = "Group";
	$menuNode["table"] = "";
	$menuNode["style"] = "";
	...
	$menuNode["title"] = "Custom Candicate Fields";
