...
$tdatakbcomments[".OriginalTable"] = "kbcomments";


$tdatakbcomments[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"list\":[\"list\"],\"view\":[\"view\"]}" );
$tdatakbcomments[".originalPagesByType"] = $tdatakbcomments[".pagesByType"];
$tdatakbcomments[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"list\":[\"list\"],\"view\":[\"view\"]}" ) );
$tdatakbcomments[".originalPages"] = $tdatakbcomments[".pages"];
$tdatakbcomments[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"list\":\"list\",\"view\":\"view\"}" );
...
$tdatakbcomments[".entityType"] = 0;
$tdatakbcomments[".connId"] = "deredevatderejadevmerqconsulta";


$tdatakbcomments[".strOriginalTableName"] = "kbcomments";
...
$masterTablesData["kbcomments"] = array();
	...
	//if !@t.bReportCrossTab
			$strOriginalDetailsTable="kbarticles";
	$masterParams = array();
