...
function checkTableName($shortTName )
{
	...
	if ("training_participants" == $shortTName )
		return true;
	if ("cities" == $shortTName )
		return true;
	if ("regions" == $shortTName )
		return true;
	if ("sub_cities" == $shortTName )
		return true;
	if ("zones" == $shortTName )
		return true;
	if ("dereja_services" == $shortTName )
		return true;
	if ("dereja_event_services" == $shortTName )
		return true;
	if ("dereja_training_services" == $shortTName )
		return true;
	if ("institution_types" == $shortTName )
		return true;
	if ("departments" == $shortTName )
		return true;
	if ("education_levels" == $shortTName )
		return true;
	if ("minor_major" == $shortTName )
		return true;
	if ("skills" == $shortTName )
		return true;
	if ("dereja_information_sources" == $shortTName )
		return true;
	if ("it_related_skills" == $shortTName )
		return true;
	if ("industry_specific_skills" == $shortTName )
		return true;
	if ("training_types" == $shortTName )
		return true;
	if ("professions" == $shortTName )
		return true;
	if ("participant_organization_types" == $shortTName )
		return true;
	if ("training_venues" == $shortTName )
		return true;
	if ("training_organizers" == $shortTName )
		return true;
	if ("training_city_towns" == $shortTName )
		return true;
	...
	if ("candidates_by_sex_age_disability" == $shortTName )
		return true;
	if ("indicator_targets" == $shortTName )
		return true;
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("AIO_Reporting_Dashboard");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("candidates_grouped_report");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("Home");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
