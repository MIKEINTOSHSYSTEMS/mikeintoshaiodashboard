...
$tdatamain[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"list\":[\"category\",\"mainpage\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatamain[".originalPagesByType"] = $tdatamain[".pagesByType"];
$tdatamain[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"export\":[\"export\"],\"list\":[\"category\",\"mainpage\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatamain[".originalPages"] = $tdatamain[".pages"];
$tdatamain[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"export\":\"export\",\"list\":\"category\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
$tdatamain[".connId"] = "deredevatderejadevmerqconsulta";
...
//	kbcomments
	...
	$detailsParam["dDataSourceTable"]="kbcomments";
		$detailsParam["dOriginalTable"] = "kbcomments";
