...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsadmin_users["English"]["usertype"] = "Usertype";
	$fieldToolTipsadmin_users["English"]["usertype"] = "";
	$placeHoldersadmin_users["English"]["usertype"] = "";
...
$tdataadmin_users[".connId"] = "deredevatderejadevmerqconsulta";
...
$tdataadmin_users[".sqlHead"] = "SELECT id,  	username,  	password,  	email,  	fullname,  	groupid,  	active,  	ext_security_id,  	userpic,  	usertype,  	reset_token,  	reset_date,  	designation";
...
//end of Filters settings
	...
	$tdataadmin_users["usertype"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "usertype";
//	reset_token
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 11;
...
//end of Filters settings
	...
	$tdataadmin_users["designation"] = $fdata;
		$tdataadmin_users[".searchableFields"][] = "designation";
