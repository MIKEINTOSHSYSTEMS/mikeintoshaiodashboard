...
$tdataadmin_comments[".OriginalTable"] = "kbcomments";


$tdataadmin_comments[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"list\":[\"list\"],\"view\":[\"view\"]}" );
$tdataadmin_comments[".originalPagesByType"] = $tdataadmin_comments[".pagesByType"];
$tdataadmin_comments[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"list\":[\"list\"],\"view\":[\"view\"]}" ) );
$tdataadmin_comments[".originalPages"] = $tdataadmin_comments[".pages"];
$tdataadmin_comments[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"list\":\"list\",\"view\":\"view\"}" );
...
$tdataadmin_comments[".connId"] = "deredevatderejadevmerqconsulta";


$tdataadmin_comments[".strOriginalTableName"] = "kbcomments";
