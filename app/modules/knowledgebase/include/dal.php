...
class tDAL
{
	var $tblproject_at_localhost__faicons;
	var $tblproject_at_localhost__kbarticles;
	var $tblproject_at_localhost__kbcategories;
	var $tblproject_at_localhost__kbcomments;
	var $tblproject_at_localhost__kbusers;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "faicons", "varname" => "project_at_localhost__faicons", "altvarname" => "faicons", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		...
		$this->lstTables[] = array("name" => "kbcomments", "varname" => "project_at_localhost__kbcomments", "altvarname" => "kbcomments", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "kbusers", "varname" => "project_at_localhost__kbusers", "altvarname" => "kbusers", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
	}
