...
$tdatakbusers[".pagesByType"] = my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatakbusers[".originalPagesByType"] = $tdatakbusers[".pagesByType"];
$tdatakbusers[".pages"] = types2pages( my_json_decode( "{\"add\":[\"add\"],\"edit\":[\"edit\"],\"list\":[\"list\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatakbusers[".originalPages"] = $tdatakbusers[".pages"];
$tdatakbusers[".defaultPages"] = my_json_decode( "{\"add\":\"add\",\"edit\":\"edit\",\"list\":\"list\",\"search\":\"search\",\"view\":\"view\"}" );
...
$tdatakbusers[".connId"] = "project_at_localhost";
...
$tdatakbusers[".arrGridTabs"] = $arrGridTabs;
...
include_once(getabspath("include/kbusers_events.php"));
$tdatakbusers[".hasEvents"] = true;
