...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "faicons", "varname" => "project_at_localhost__faicons", "altvarname" => "faicons", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			...
			$dalTables[$conn->connId][] = array("name" => "kbcomments", "varname" => "project_at_localhost__kbcomments", "altvarname" => "kbcomments", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "kbusers", "varname" => "project_at_localhost__kbusers", "altvarname" => "kbusers", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		}
	}
