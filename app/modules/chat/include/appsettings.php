...
$custom_labels["English"] = array();
	$custom_labels["English"]['search_id'] = "Search";
	$custom_labels["English"]['showall_id'] = "Show all";
	$custom_labels["English"]['nomessage_id'] = "No messages";
	$custom_labels["English"]['drop_here'] = "Drop here";
	$custom_labels["English"]['drag_here'] = "Drag files here";
	$custom_labels["English"]['close_window'] = "Close window";
	$custom_labels["English"]['typing_id'] = "typing";
	$custom_labels["English"]['not_read'] = "not read";
	$custom_labels["English"]['view_in_channel'] = "View in chat";
	$custom_labels["English"]['search_result'] = "Search results for";
	$custom_labels["English"]['error_login'] = "You need to select a login table on Security screen in the software.";
	$custom_labels["English"]['delete_message'] = "Delete message";
	$custom_labels["English"]['edit_message'] = "Edit message";
	$custom_labels["English"]['find_user'] = "Find user";
	$custom_labels["English"]['find_chat'] = "Find chat";
	$custom_labels["English"]['empty_selected_user'] = "No selected users";
	$custom_labels["English"]['groupname_exist'] = "Current group name exists";
	$custom_labels["English"]['seacrh_not_found'] = "No chats found";
	$custom_labels["English"]['delete_chat'] = "Delete Chat";
	$custom_labels["English"]['leave_chat'] = "Leave Chat";
	$custom_labels["English"]['rename_chat'] = "Rename Chat";
	$custom_labels["English"]['manage_chat'] = "Manage Chat";
	$custom_labels["English"]['delete_message_undone'] = "Are you sure you want to delete this message? This cannot be undone.";
	$custom_labels["English"]['cancel'] = "Cancel";
	$custom_labels["English"]['delete'] = "Delete";
	$custom_labels["English"]['save_change'] = "Save Changes";
	$custom_labels["English"]['yes'] = "Yes";
	$custom_labels["English"]['no'] = "No";
	$custom_labels["English"]['save'] = "Save";
	$custom_labels["English"]['stop_audio'] = "Stop Record Audio";
	$custom_labels["English"]['calling_you'] = "is calling you";
	$custom_labels["English"]['call_to'] = "Call to";
...
$styleOverrides["chat_history_add"] = array(
	"theme" => "cerulean",
	"size" => "normal",
	"path" => "styles\\bootstrap\\custom\\chat_history_add",
);
...
$projectBuildKey = "3514_1669635527";
$wizardBuildKey = "39925";
$projectBuildNumber = "3514";
...
$tableCaptions["English"]["chat_settings"] = "Chat Settings";
$tableCaptions["English"]["chat_files"] = "Chat Files";
