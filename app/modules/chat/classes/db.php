...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "chat_files", "varname" => "project_at_localhost__chat_files", "altvarname" => "chat_files", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "chat_groups", "varname" => "project_at_localhost__chat_groups", "altvarname" => "chat_groups", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "chat_history", "varname" => "project_at_localhost__chat_history", "altvarname" => "chat_history", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "chat_peopletype", "varname" => "project_at_localhost__chat_peopletype", "altvarname" => "chat_peopletype", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "chat_settings", "varname" => "project_at_localhost__chat_settings", "altvarname" => "chat_settings", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "chat_timezone", "varname" => "project_at_localhost__chat_timezone", "altvarname" => "chat_timezone", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "chat_users", "varname" => "project_at_localhost__chat_users", "altvarname" => "chat_users", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "project_at_localhost__users", "altvarname" => "users", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		}
	}
