...
class ConnectionManager_Base
{
	...
	{
		$connectionsIds = array();
		$connectionsIds["chat_history"] = "project_at_localhost";
		$connectionsIds["chat_users"] = "project_at_localhost";
		$connectionsIds["chat_settings"] = "project_at_localhost";
		$connectionsIds["chat_files"] = "project_at_localhost";
		$connectionsIds["chat_groups"] = "project_at_localhost";
		$connectionsIds["chat_peopletype"] = "project_at_localhost";
		$connectionsIds["chat_timezone"] = "project_at_localhost";
		$connectionsIds["users"] = "project_at_localhost";
