...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "hd_categories", "varname" => "project_at_localhost__hd_categories", "altvarname" => "hd_categories", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_directions", "varname" => "project_at_localhost__hd_directions", "altvarname" => "hd_directions", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_folders", "varname" => "project_at_localhost__hd_folders", "altvarname" => "hd_folders", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_mailtemplates", "varname" => "project_at_localhost__hd_mailtemplates", "altvarname" => "hd_mailtemplates", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_messages", "varname" => "project_at_localhost__hd_messages", "altvarname" => "hd_messages", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_priorities", "varname" => "project_at_localhost__hd_priorities", "altvarname" => "hd_priorities", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_quicktemplates", "varname" => "project_at_localhost__hd_quicktemplates", "altvarname" => "hd_quicktemplates", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_servers", "varname" => "project_at_localhost__hd_servers", "altvarname" => "hd_servers", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_settings", "varname" => "project_at_localhost__hd_settings", "altvarname" => "hd_settings", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_status", "varname" => "project_at_localhost__hd_status", "altvarname" => "hd_status", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_tickets", "varname" => "project_at_localhost__hd_tickets", "altvarname" => "hd_tickets", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_todolist", "varname" => "project_at_localhost__hd_todolist", "altvarname" => "hd_todolist", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "hd_users", "varname" => "project_at_localhost__hd_users", "altvarname" => "hd_users", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "kbarticles", "varname" => "project_at_localhost__kbarticles", "altvarname" => "kbarticles", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "kbcategories", "varname" => "project_at_localhost__kbcategories", "altvarname" => "kbcategories", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		}
	}
