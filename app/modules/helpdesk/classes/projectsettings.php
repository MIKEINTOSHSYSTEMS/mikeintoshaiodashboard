...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("hd_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "hd_servers" ] = array( "url" => "hd_servers", "type" => 0 );
	$projectEntitiesReverse[ "hd_servers" ] = "hd_servers";
	$projectEntities[ "hd_settings" ] = array( "url" => "hd_settings", "type" => 0 );
	$projectEntitiesReverse[ "hd_settings" ] = "hd_settings";
	$projectEntities[ "hd_tickets" ] = array( "url" => "hd_tickets", "type" => 0 );
	$projectEntitiesReverse[ "hd_tickets" ] = "hd_tickets";
	$projectEntities[ "hd_messages" ] = array( "url" => "hd_messages", "type" => 0 );
	$projectEntitiesReverse[ "hd_messages" ] = "hd_messages";
	$projectEntities[ "hd_folders" ] = array( "url" => "hd_folders", "type" => 0 );
	$projectEntitiesReverse[ "hd_folders" ] = "hd_folders";
	$projectEntities[ "hd_priorities" ] = array( "url" => "hd_priorities", "type" => 0 );
	$projectEntitiesReverse[ "hd_priorities" ] = "hd_priorities";
	$projectEntities[ "hd_categories" ] = array( "url" => "hd_categories", "type" => 0 );
	$projectEntitiesReverse[ "hd_categories" ] = "hd_categories";
	$projectEntities[ "hd_directions" ] = array( "url" => "hd_directions", "type" => 0 );
	$projectEntitiesReverse[ "hd_directions" ] = "hd_directions";
	$projectEntities[ "hd_users" ] = array( "url" => "hd_users", "type" => 0 );
	$projectEntitiesReverse[ "hd_users" ] = "hd_users";
	$projectEntities[ "hd_status" ] = array( "url" => "hd_status", "type" => 0 );
	$projectEntitiesReverse[ "hd_status" ] = "hd_status";
	$projectEntities[ "hd_quicktemplates" ] = array( "url" => "hd_quicktemplates", "type" => 0 );
	$projectEntitiesReverse[ "hd_quicktemplates" ] = "hd_quicktemplates";
	...
	$projectEntities[ "hd_mailtemplates" ] = array( "url" => "hd_mailtemplates", "type" => 0 );
	$projectEntitiesReverse[ "hd_mailtemplates" ] = "hd_mailtemplates";
	$projectEntities[ "hd_todolist" ] = array( "url" => "hd_todolist", "type" => 0 );
	$projectEntitiesReverse[ "hd_todolist" ] = "hd_todolist";
}
