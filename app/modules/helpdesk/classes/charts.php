...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("hd_servers" == $this->chrt_array['tables'][0])
			return true;
		if("hd_settings" == $this->chrt_array['tables'][0])
			return true;
		if("hd_tickets" == $this->chrt_array['tables'][0])
			return true;
		if("hd_messages" == $this->chrt_array['tables'][0])
			return true;
		if("hd_folders" == $this->chrt_array['tables'][0])
			return true;
		if("hd_priorities" == $this->chrt_array['tables'][0])
			return true;
		if("hd_categories" == $this->chrt_array['tables'][0])
			return true;
		if("hd_directions" == $this->chrt_array['tables'][0])
			return true;
		if("hd_users" == $this->chrt_array['tables'][0])
			return true;
		if("hd_status" == $this->chrt_array['tables'][0])
			return true;
		if("hd_quicktemplates" == $this->chrt_array['tables'][0])
			return true;
		...
		if("kbarticles" == $this->chrt_array['tables'][0])
			return true;
		if("hd_mailtemplates" == $this->chrt_array['tables'][0])
			return true;
		if("hd_todolist" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
