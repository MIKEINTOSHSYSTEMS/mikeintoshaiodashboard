...
class ConnectionManager_Base
{
	...
	{
		$connectionsIds = array();
		$connectionsIds["hd_servers"] = "project_at_localhost";
		$connectionsIds["hd_settings"] = "project_at_localhost";
		$connectionsIds["hd_tickets"] = "project_at_localhost";
		$connectionsIds["hd_messages"] = "project_at_localhost";
		$connectionsIds["hd_folders"] = "project_at_localhost";
		$connectionsIds["hd_priorities"] = "project_at_localhost";
		$connectionsIds["hd_categories"] = "project_at_localhost";
		$connectionsIds["hd_directions"] = "project_at_localhost";
		$connectionsIds["hd_users"] = "project_at_localhost";
		$connectionsIds["hd_status"] = "project_at_localhost";
		$connectionsIds["hd_quicktemplates"] = "project_at_localhost";
		$connectionsIds["kbarticles"] = "project_at_localhost";
		$connectionsIds["kbcategories"] = "project_at_localhost";
		$connectionsIds["main"] = "project_at_localhost";
		$connectionsIds["hd_mailtemplates"] = "project_at_localhost";
		$connectionsIds["hd_todolist"] = "project_at_localhost";
