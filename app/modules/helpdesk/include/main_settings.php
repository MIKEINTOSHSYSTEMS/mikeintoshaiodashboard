...
$tdatamain[".OwnerID"] = "";
$tdatamain[".OriginalTable"] = "kbarticles";


$tdatamain[".pagesByType"] = my_json_decode( "{\"edit\":[\"edit\"],\"export\":[\"export\"],\"list\":[\"list\",\"list1\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" );
$tdatamain[".originalPagesByType"] = $tdatamain[".pagesByType"];
$tdatamain[".pages"] = types2pages( my_json_decode( "{\"edit\":[\"edit\"],\"export\":[\"export\"],\"list\":[\"list\",\"list1\"],\"masterlist\":[\"masterlist\"],\"masterprint\":[\"masterprint\"],\"print\":[\"print\"],\"search\":[\"search\"],\"view\":[\"view\"]}" ) );
$tdatamain[".originalPages"] = $tdatamain[".pages"];
$tdatamain[".defaultPages"] = my_json_decode( "{\"edit\":\"edit\",\"export\":\"export\",\"list\":\"list\",\"masterlist\":\"masterlist\",\"masterprint\":\"masterprint\",\"print\":\"print\",\"search\":\"search\",\"view\":\"view\"}" );
...
if(mlang_getcurrentlang()=="English")
{
	...
	$fieldLabelsmain["English"]["approved"] = "Approved";
	$fieldToolTipsmain["English"]["approved"] = "";
	$placeHoldersmain["English"]["approved"] = "";
	$fieldLabelsmain["English"]["DateCreated"] = "Date Created";
...
$tdatamain[".connId"] = "project_at_localhost";


$tdatamain[".strOriginalTableName"] = "kbarticles";
...
$tdatamain[".googleLikeFields"][] = "approved";
...
$tdatamain[".orderindexes"] = array();
	$tdatamain[".orderindexes"][] = array(5, (1 ? "ASC" : "DESC"), "Category");



$tdatamain[".sqlHead"] = "select approved,  ArticleID,  ArticleID AS ArticleID2,  ArticleID AS ArticleIDedit,  Category,  DateCreated,  Problem,  Solution,  Title,  Views";
...
//	Custom field settings
	...
	$fdata["Label"] = GetFieldLabel("main","approved");
	$fdata["FieldType"] = 200;
...
//end of Filters settings
	...
	$tdatamain["approved"] = $fdata;
		$tdatamain[".searchableFields"][] = "approved";
//	ArticleID
//	Custom field settings
	$fdata = array();
	$fdata["Index"] = 2;
...
$proto0["m_strFieldList"] = "approved,  ArticleID,  ArticleID AS ArticleID2,  ArticleID AS ArticleIDedit,  Category,  DateCreated,  Problem,  Solution,  Title,  Views";
...
$proto26["m_link"] = "SQLL_MAIN";
			$proto27=array();
$proto27["m_strName"] = "kbarticles";
$proto27["m_srcTableName"] = "main";
$proto27["m_columns"] = array();
$proto27["m_columns"][] = "approved";
$proto27["m_columns"][] = "ArticleID";
$proto27["m_columns"][] = "Category";
$proto27["m_columns"][] = "DateCreated";
$proto27["m_columns"][] = "Problem";
$proto27["m_columns"][] = "Solution";
$proto27["m_columns"][] = "Title";
$proto27["m_columns"][] = "Views";
$proto27["m_columns"][] = "keyworlds";
$obj = new SQLTable($proto27);

$proto26["m_table"] = $obj;
$proto26["m_sql"] = "kbarticles";
$proto26["m_alias"] = "";
