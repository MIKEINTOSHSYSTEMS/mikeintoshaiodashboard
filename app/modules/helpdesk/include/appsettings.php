...
$custom_labels["English"] = array();
	$custom_labels["English"]['total_tickets'] = "Total Tickets";
	$custom_labels["English"]['delete_confirm'] = "Do you really want to delete this record?";
	$custom_labels["English"]['browse_files'] = "Browse files";
	$custom_labels["English"]['suggested_solutions'] = "Suggested Solutions";
	$custom_labels["English"]['article'] = "Article";
	$custom_labels["English"]['views'] = "Views";
	$custom_labels["English"]['add_to_reply'] = "Add to reply";
	$custom_labels["English"]['show_bcc'] = "Show BCC";
	$custom_labels["English"]['show_cc'] = "Show CC";
	$custom_labels["English"]['please_select'] = "Please select one or more selected tickets.";
	$custom_labels["English"]['delete_confirm1'] = "Do you really want to closed selected tickets?";
	$custom_labels["English"]['close_tickets_confirm'] = "Do you really want to closed selected tickets?";
	$custom_labels["English"]['close_confirm'] = "Do you really want to closed this ticket?";
	$custom_labels["English"]['add_new_article'] = "Add new article";
	$custom_labels["English"]['reply'] = "Reply";
	$custom_labels["English"]['just_now'] = "just now";
	$custom_labels["English"]['one_minute_ago'] = "one minute ago";
	$custom_labels["English"]['count_minutes_ago'] = "%minutes% minutes ago";
	$custom_labels["English"]['an_hour_ago'] = "an hour ago";
	$custom_labels["English"]['count_hours_ago'] = "%hours% hrs ago";
	$custom_labels["English"]['yesterday'] = "yesterday";
	$custom_labels["English"]['count_days_ago'] = "%days% days ago";
	$custom_labels["English"]['a_week_ago'] = "a week ago";
	$custom_labels["English"]['count_week_ago'] = "%weeks% weeks ago";
	$custom_labels["English"]['a_month_ago'] = "a month ago";
	$custom_labels["English"]['count_month_ago'] = "%months% months ago";
	$custom_labels["English"]['one_year_ago'] = "one year ago";
	$custom_labels["English"]['count_year_ago'] = "%years% years ago";
	$custom_labels["English"]['open'] = "Open";
	$custom_labels["English"]['awaiting_for_response'] = "Awaiting for response";
	$custom_labels["English"]['category'] = "Category";
	$custom_labels["English"]['tickets_assigned'] = "Show all tickets assigned to %user%";
	$custom_labels["English"]['client'] = "Client";
	$custom_labels["English"]['show_customer_tickets'] = "Show all tickets of this customer";
	$custom_labels["English"]['reply'] = "Reply";
	$custom_labels["English"]['resend'] = "Resend";
	$custom_labels["English"]['delete'] = "Delete";
	$custom_labels["English"]['export_article'] = "Export article";
	$custom_labels["English"]['printer_friendly_version'] = "Printer-friendly version";
...
include("config.php");
$globalSettings["strSMTPUser"] = $config_strSMTPUser;
$globalSettings["strSMTPServer"] = $config_strSMTPServer;
$globalSettings["strSMTPPort"] = $config_strSMTPPort;
$globalSettings["strSMTPPassword"] = $config_strSMTPPassword;
$globalSettings["strFromEmail"] = $config_strFromEmail;
...
$globalSettings["LandingTable"] = "hd_tickets";
$globalSettings["LandingPage"] = "list";
$globalSettings["LandingURL"] = "hd_tickets_list.php?page=list";
$globalSettings["LandingPageId"] = "list";

$globalSettings["ProjectLogo"] = array();
$globalSettings["ProjectLogo"]["English"] = "Helpdesk";
...
$globalSettings["usersDatasourceTable"] = "hd_users";


$globalSettings["jwtSecret"] = "StEIhkrLXJBnHauPILjA";
...
$projectBuildKey = "2359_1669644248";
$wizardBuildKey = "39925";
$projectBuildNumber = "2359";
...
$tableCaptions["English"]["hd_servers"] = "Servers";
$tableCaptions["English"]["hd_settings"] = "Settings";
$tableCaptions["English"]["hd_tickets"] = "Tickets";
$tableCaptions["English"]["hd_messages"] = "Messages";
$tableCaptions["English"]["hd_folders"] = "Folders";
$tableCaptions["English"]["hd_priorities"] = "Priorities";
$tableCaptions["English"]["hd_categories"] = "Hd Categories";
$tableCaptions["English"]["hd_directions"] = "Hd Directions";
$tableCaptions["English"]["hd_users"] = "Hd Users";
$tableCaptions["English"]["hd_status"] = "Hd Status";
$tableCaptions["English"]["hd_quicktemplates"] = "Quick templates";
...
$tableCaptions["English"]["hd_mailtemplates"] = "Templates";
$tableCaptions["English"]["hd_todolist"] = "Hd Todolist";
...
$_SESSION["Knowledge_Base_Integration"] = DBLookup("select ".AddFieldWrappers("knowledge_base")." from ".AddTableWrappers("hd_settings"));
$_SESSION["user_keyfield_for_query"] = $loginKeyFields[0];
$_SESSION["user_table_for_query"] = $cLoginTable;
$userData = Security::currentUserData();

DB::SetConnection(DB::ConnectionByTable(Security::getLoginTable()));
DB::Exec( DB::PrepareSQL("update ".AddTableWrappers($_SESSION["user_table_for_query"])." set ".AddTableWrappers("last_activity")."=':1' where ".AddFieldWrappers($_SESSION["user_keyfield_for_query"])."=:2",date("Y-m-d H:i:s"),$userData[$_SESSION["user_keyfield_for_query"]]) );
DB::SetConnection(DB::DefaultConnection());

if( postvalue("viewingPage") != false){
	DB::SetConnection(DB::ConnectionByTable(Security::getLoginTable()));
	$sql = DB::PrepareSQL("update ".AddTableWrappers($_SESSION["user_table_for_query"])." set ".AddTableWrappers("viewing_page")."=':1' where ".AddFieldWrappers($_SESSION["user_keyfield_for_query"])."=:2",postvalue("viewingPage"),$userData[$_SESSION["user_keyfield_for_query"]]);
	DB::Exec( $sql );
	

	if(postvalue("is_open_reply") != false && intval(postvalue("is_open_reply")) >0 )
		$sql = DB::PrepareSQL("update ".AddTableWrappers($_SESSION["user_table_for_query"])." set ".AddTableWrappers("repling_in")."=':1' where ".AddFieldWrappers($_SESSION["user_keyfield_for_query"])."=:2",postvalue("viewingPage"),$userData[$_SESSION["user_keyfield_for_query"]]);
	DB::SetConnection(DB::DefaultConnection());

	$response = array();
	$response["veiwingTickets"] = getusersInTicket(postvalue("viewingPage"));
	$response["replingInTicket"] = getReplingInTicket(postvalue("viewingPage"));

	if(postvalue("viewingPage")==="-"){
		$userData = Security::currentUserData();	
		DB::SetConnection(DB::ConnectionByTable(Security::getLoginTable()));
	...
	if(postvalue("viewingPage")!=="-"){
		print my_json_encode($response);
	}
	exit();
}
if( postvalue("getLastViewingUser") != false){
	$ticket_id = postvalue("ticket_id");
	$users = getusersInTicket($ticket_id);
	if(count($users) > 0) echo array_shift($users);
		else "";
	exit();
}
