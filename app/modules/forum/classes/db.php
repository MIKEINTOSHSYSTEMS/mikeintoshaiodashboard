...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "forumcategories", "varname" => "project_at_localhost__forumcategories", "altvarname" => "forumcategories", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "forumcategorysubscribers", "varname" => "project_at_localhost__forumcategorysubscribers", "altvarname" => "forumcategorysubscribers", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "forumreplies", "varname" => "project_at_localhost__forumreplies", "altvarname" => "forumreplies", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "forumsettings", "varname" => "project_at_localhost__forumsettings", "altvarname" => "forumsettings", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "forumsubscribers", "varname" => "project_at_localhost__forumsubscribers", "altvarname" => "forumsubscribers", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "forumtopics", "varname" => "project_at_localhost__forumtopics", "altvarname" => "forumtopics", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "forumusers", "varname" => "project_at_localhost__forumusers", "altvarname" => "forumusers", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "forumusers_data", "varname" => "project_at_localhost__forumusers_data", "altvarname" => "forumusers_data", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		}
	}
