...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("forumcategories" == $this->chrt_array['tables'][0])
			return true;
		if("forumreplies" == $this->chrt_array['tables'][0])
			return true;
		if("forumtopics" == $this->chrt_array['tables'][0])
			return true;
		if("forumsubscribers" == $this->chrt_array['tables'][0])
			return true;
		...
		if("forumreplies" == $this->chrt_array['tables'][0])
			return true;
		if("forumsettings" == $this->chrt_array['tables'][0])
			return true;
		if("forumcategorysubscribers" == $this->chrt_array['tables'][0])
			return true;
		if("forumusers" == $this->chrt_array['tables'][0])
			return true;
		if("forumusers_data" == $this->chrt_array['tables'][0])
			return true;
		if("forumusers_data" == $this->chrt_array['tables'][0])
			return true;
		return false;
