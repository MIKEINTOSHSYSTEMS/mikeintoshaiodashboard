...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("forumusers", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "forumcategories" ] = array( "url" => "forumcategories", "type" => 0 );
	$projectEntitiesReverse[ "forumcategories" ] = "forumcategories";
	$projectEntities[ "forumreplies" ] = array( "url" => "forumreplies", "type" => 0 );
	$projectEntitiesReverse[ "forumreplies" ] = "forumreplies";
	$projectEntities[ "forumtopics" ] = array( "url" => "forumtopics", "type" => 0 );
	$projectEntitiesReverse[ "forumtopics" ] = "forumtopics";
	$projectEntities[ "forumsubscribers" ] = array( "url" => "forumsubscribers", "type" => 0 );
	$projectEntitiesReverse[ "forumsubscribers" ] = "forumsubscribers";
	$projectEntities[ "Dashboard" ] = array( "url" => "Dashboard", "type" => 4 );
	$projectEntitiesReverse[ "Dashboard" ] = "Dashboard";
	$projectEntities[ "forumtopics_view" ] = array( "url" => "forumtopics_view", "type" => 1 );
	$projectEntitiesReverse[ "forumtopics_view" ] = "forumtopics_view";
	$projectEntities[ "forumsubscribers_dash" ] = array( "url" => "forumsubscribers_dash", "type" => 1 );
	$projectEntitiesReverse[ "forumsubscribers_dash" ] = "forumsubscribers_dash";
	$projectEntities[ "forumreplies_chart" ] = array( "url" => "forumreplies_chart", "type" => 3 );
	$projectEntitiesReverse[ "forumreplies_chart" ] = "forumreplies_chart";
	$projectEntities[ "forumsettings" ] = array( "url" => "forumsettings", "type" => 0 );
	$projectEntitiesReverse[ "forumsettings" ] = "forumsettings";
	$projectEntities[ "forumcategorysubscribers" ] = array( "url" => "forumcategorysubscribers", "type" => 0 );
	$projectEntitiesReverse[ "forumcategorysubscribers" ] = "forumcategorysubscribers";
	$projectEntities[ "forumusers" ] = array( "url" => "forumusers", "type" => 0 );
	$projectEntitiesReverse[ "forumusers" ] = "forumusers";
	$projectEntities[ "forumusers_data" ] = array( "url" => "forumusers_data", "type" => 0 );
	$projectEntitiesReverse[ "forumusers_data" ] = "forumusers_data";
	$projectEntities[ "profile" ] = array( "url" => "profile", "type" => 1 );
	$projectEntitiesReverse[ "profile" ] = "profile";
}
