...
$custom_labels["English"] = array();
	$custom_labels["English"]['display_name'] = "Display Name";
	$custom_labels["English"]['no_information'] = "No information";
	$custom_labels["English"]['blue'] = "Blue";
	$custom_labels["English"]['white'] = "White";
	$custom_labels["English"]['purple'] = "Purple";
	$custom_labels["English"]['green'] = "Green";
	$custom_labels["English"]['red'] = "Red";
	$custom_labels["English"]['orange'] = "Orange";
	$custom_labels["English"]['blue_light'] = "Blue Light";
	$custom_labels["English"]['white_light'] = "White Light";
	$custom_labels["English"]['purple_light'] = "Purple Light";
	$custom_labels["English"]['green_light'] = "Green Light";
	$custom_labels["English"]['red_light'] = "Red Light";
	$custom_labels["English"]['orange_light'] = "Orange Light";
	$custom_labels["English"]['list_of_subscriptions_updated'] = "List of subscriptions updated";
	$custom_labels["English"]['notification_subject'] = "Forum Notification";
	$custom_labels["English"]['notification_appeal'] = "Dear {displayname}";
	$custom_labels["English"]['notification_reply_from'] = "Reply from {author}";
	$custom_labels["English"]['notification_unsubscribe'] = "Unsubscribe from this topic";
	$custom_labels["English"]['notification_go'] = "You can {a}go to the topic{/a} or";
	$custom_labels["English"]['unsubscribe'] = "Unsubscribe";
	$custom_labels["English"]['unsubscribed'] = "You have unsubscribed";
	$custom_labels["English"]['active_user_online'] = "active user(s) (in the past 15 minutes)";
	$custom_labels["English"]['active_users'] = "Active users";
	$custom_labels["English"]['notification_unsubscribe_category'] = "Unsubscribe from this category";
	$custom_labels["English"]['notification_new_category'] = "New topic created in category {category}";
	$custom_labels["English"]['notification_new_topic'] = "A new message has been posted to this topic.";
	$custom_labels["English"]['solved'] = "[SOLVED]";
	$custom_labels["English"]['autoLock'] = "auto-lock after {days} days";
	$custom_labels["English"]['hand_lock'] = "lock now";
	$custom_labels["English"]['hand_unlock'] = "do not lock";
...
$globalSettings["LandingTable"] = "forumtopics";
$globalSettings["LandingPage"] = "list";
$globalSettings["LandingURL"] = "forumtopics_list.php?page=list";
$globalSettings["LandingPageId"] = "list";

$globalSettings["ProjectLogo"] = array();
$globalSettings["ProjectLogo"]["English"] = "<span style=\"align-items: center;display: flex;color:white;\"><img width=\"30px\" src=\"images/icons48.png\"><span id='logotext'>&nbsp;&nbsp;Forum Project</span></span>";
 ...
 * DEPRECATED
 */
$cLoginTable = "forumusers";
$cDisplayNameField = "displayname";
...
$globalSettings["usersDatasourceTable"] = "forumusers";


$globalSettings["jwtSecret"] = "i2LrikJaBIVjK6hUA6ha";
...
$projectBuildKey = "2536_1669640864";
$wizardBuildKey = "39925";
$projectBuildNumber = "2536";
...
$tableCaptions["English"]["forumcategories"] = "Categories";
$tableCaptions["English"]["forumreplies"] = "Replies";
$tableCaptions["English"]["forumtopics"] = "All topics";
$tableCaptions["English"]["forumsubscribers"] = "Subscriptions";
$tableCaptions["English"]["forumtopics_view"] = "My topics";
$tableCaptions["English"]["forumsubscribers_dash"] = "My subscriptions";
$tableCaptions["English"]["forumreplies_chart"] = "Posts Chart";
$tableCaptions["English"]["Dashboard"] = "Dashboard";
$tableCaptions["English"]["forumsettings"] = "Settings";
$tableCaptions["English"]["forumcategorysubscribers"] = "Forumcategorysubscribers";
$tableCaptions["English"]["forumusers"] = "Forumusers";
$tableCaptions["English"]["forumusers_data"] = "Forumusers Admin";
$tableCaptions["English"]["profile"] = "Profile";
...
include_once(getabspath("include/forum_functions.php"));
$_SESSION["loginKeyField"] = $loginKeyFields[0];
if( Security::isLoggedIn() ){
	setUserData();
	$currentDateTimeForDb = localdatetime2db( runner_date_format("m-d-y H:i:s") );
	updateUserData(array("last_activity" =>$currentDateTimeForDb));
}

if(postvalue("scheme")){
	if(Security::isLoggedIn())
		updateUserData(array("scheme" => postvalue("scheme")));
	else
		setcookie("colorscheme",postvalue("scheme"),time()+time()+60*60*24*1);
	$_SESSION["colorscheme"] = postvalue("scheme");
}


if( postvalue("userpic") ) {

	$userDataRs =DB::Select($cLoginTable,array($cUserNameField => postvalue("userpic") ));
	$userData = $userDataRs->fetchAssoc();
