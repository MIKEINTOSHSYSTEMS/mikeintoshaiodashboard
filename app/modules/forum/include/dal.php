...
class tDAL
{
	var $tblproject_at_localhost__forumcategories;
	var $tblproject_at_localhost__forumcategorysubscribers;
	var $tblproject_at_localhost__forumreplies;
	var $tblproject_at_localhost__forumsettings;
	var $tblproject_at_localhost__forumsubscribers;
	var $tblproject_at_localhost__forumtopics;
	var $tblproject_at_localhost__forumusers;
	var $tblproject_at_localhost__forumusers_data;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "forumcategories", "varname" => "project_at_localhost__forumcategories", "altvarname" => "forumcategories", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "forumcategorysubscribers", "varname" => "project_at_localhost__forumcategorysubscribers", "altvarname" => "forumcategorysubscribers", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "forumreplies", "varname" => "project_at_localhost__forumreplies", "altvarname" => "forumreplies", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "forumsettings", "varname" => "project_at_localhost__forumsettings", "altvarname" => "forumsettings", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "forumsubscribers", "varname" => "project_at_localhost__forumsubscribers", "altvarname" => "forumsubscribers", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "forumtopics", "varname" => "project_at_localhost__forumtopics", "altvarname" => "forumtopics", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "forumusers", "varname" => "project_at_localhost__forumusers", "altvarname" => "forumusers", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "forumusers_data", "varname" => "project_at_localhost__forumusers_data", "altvarname" => "forumusers_data", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
	}
