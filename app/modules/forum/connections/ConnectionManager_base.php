...
class ConnectionManager_Base
{
	...
	{
		$connectionsIds = array();
		$connectionsIds["forumcategories"] = "project_at_localhost";
		$connectionsIds["forumreplies"] = "project_at_localhost";
		$connectionsIds["forumtopics"] = "project_at_localhost";
		$connectionsIds["forumsubscribers"] = "project_at_localhost";
		$connectionsIds["forumtopics_view"] = "project_at_localhost";
		$connectionsIds["forumsubscribers_dash"] = "project_at_localhost";
		$connectionsIds["forumreplies_chart"] = "project_at_localhost";
		$connectionsIds["forumsettings"] = "project_at_localhost";
		$connectionsIds["forumcategorysubscribers"] = "project_at_localhost";
		$connectionsIds["forumusers"] = "project_at_localhost";
		$connectionsIds["forumusers_data"] = "project_at_localhost";
		$connectionsIds["profile"] = "project_at_localhost";
