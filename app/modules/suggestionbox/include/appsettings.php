...
$custom_labels["English"] = array();
	$custom_labels["English"]['votes'] = "votes";
	$custom_labels["English"]['new'] = "New";
	$custom_labels["English"]['top'] = "Top";
	$custom_labels["English"]['suggested_by'] = "Suggested By";
	$custom_labels["English"]['comments'] = "Comments";
	$custom_labels["English"]['you'] = "You";
	$custom_labels["English"]['awaiting_moderation'] = "Awaiting moderation";
	$custom_labels["English"]['deleted'] = "Deleted";
	$custom_labels["English"]['approved'] = "Approved";
	$custom_labels["English"]['spam'] = "Delete and block IP address";
	$custom_labels["English"]['_all_except_done'] = " All except done";
	$custom_labels["English"]['project_name'] = "My Project";
	$custom_labels["English"]['change_status'] = "Change status";
	$custom_labels["English"]['categories'] = "Categories";
	$custom_labels["English"]['create_new_category'] = "Create new category";
	$custom_labels["English"]['manage_category'] = "Manage categories";
	$custom_labels["English"]['status_marked'] = "This suggestion has been marked as %status%.";
	$custom_labels["English"]['category_marked'] = "This suggestion has been updated with %category%.";
	$custom_labels["English"]['already_posted'] = "Is your suggestion already posted?";
	$custom_labels["English"]['results'] = "Results";
	$custom_labels["English"]['see_all_results'] = "See all results";
	$custom_labels["English"]['admin'] = "Admin";
	$custom_labels["English"]['voted_up'] = "Voted up";
	$custom_labels["English"]['upvote'] = "Upvote";
	$custom_labels["English"]['pinthis'] = "Pin this";
	$custom_labels["English"]['unpin'] = "Unpin";
	$custom_labels["English"]['pinned'] = "Pinned";
	$custom_labels["English"]['awaiting_approval'] = "Awaiting approval";
	...
	$custom_labels["English"]['count_years_ago'] = "%years% years ago";
...
$globalSettings["LandingTable"] = "sgb_suggestions";
$globalSettings["LandingPage"] = "list";
$globalSettings["LandingURL"] = "sgb_suggestions_list.php?page=list";
$globalSettings["LandingPageId"] = "list";

$globalSettings["ProjectLogo"] = array();
$globalSettings["ProjectLogo"]["English"] = "Suggestion Box";
...
$globalSettings["usersDatasourceTable"] = "sgb_users";


$globalSettings["jwtSecret"] = "RkIYtNAiBjHKtfCaFIWU";
...
$projectBuildKey = "1181_1670418449";
$wizardBuildKey = "39925";
$projectBuildNumber = "1181";
...
$tableCaptions["English"]["sgb_users"] = "Sgb Users";
$tableCaptions["English"]["sgb_suggestions"] = "Sgb Suggestions";
$tableCaptions["English"]["sgb_status"] = "Sgb Status";
$tableCaptions["English"]["sgb_categories"] = "Sgb Categories";
$tableCaptions["English"]["sgb_votes"] = "Sgb Votes";
$tableCaptions["English"]["sgb_comments"] = "Sgb Comments";
$tableCaptions["English"]["sgb_admin_suggestions"] = "Sgb Admin Suggestions";
$tableCaptions["English"]["sgb_admin_comments"] = "Sgb Admin Comments";
$tableCaptions["English"]["sgb_notify"] = "Sgb Notify";
$tableCaptions["English"]["sgb_users_suggestions"] = "Suggestions";
$tableCaptions["English"]["sgb_users_comments"] = "Comments";
$tableCaptions["English"]["contributor"] = "Contributor";
$tableCaptions["English"]["sgb_merge"] = "Sgb Merge";
$tableCaptions["English"]["sgb_split"] = "Sgb Split";
$tableCaptions["English"]["sgb_blockedip"] = "Blocked IP addresses";
...
/* login table key */
$_SESSION["lkey"] = $loginKeyFields[0];
/* login table */
$_SESSION["ltable"] = GetGlobalData("usersDatasourceTable");
if( GetDatabaseType() == 4 || GetDatabaseType() == 2) { // PostgreSQL
		if( strpos($_SESSION["lkeyfield"],".") !== false ){
			$lparts = explode(".",$_SESSION["ltable"]);
			$_SESSION["ltable"] = $lparts[1];
		}
}

include_once "sgb_functions.php";
$scriptname = getFileWoExtension( getFileNameFromURL() );

//blocked
$brs = DB::Select("sgb_blockedip",array("ip" => $_SERVER["REMOTE_ADDR"]));
$bl = $brs->fetchAssoc();
if($bl && !Security::isLoggedIn() &&  $scriptname!=="sgb_suggestions_view"){
	HeaderRedirect("sgb_suggestions","view");
	exit();
}

$week_ago = time() - (7 * 24 * 60 * 60);
$week_ago = getYMDdate($week_ago) . " " . getHISdate($week_ago);

DB::Delete("sgb_suggestions",AddFieldWrappers("deleted_date")." < '".$week_ago."' and ".AddFieldWrappers("status")."= 'deleted'");
DB::Delete("sgb_comments",AddFieldWrappers("deleted_date")." < '".$week_ago."' and ".AddFieldWrappers("status")." in('deleted','spam')");
