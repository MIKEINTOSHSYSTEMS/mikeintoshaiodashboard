...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("todoboards" == $this->chrt_array['tables'][0])
			return true;
		if("todocards" == $this->chrt_array['tables'][0])
			return true;
		if("todocategories" == $this->chrt_array['tables'][0])
			return true;
		if("todolists" == $this->chrt_array['tables'][0])
			return true;
		...
		if("todocards" == $this->chrt_array['tables'][0])
			return true;
		if("todousers" == $this->chrt_array['tables'][0])
			return true;
		if("calcategory" == $this->chrt_array['tables'][0])
			return true;
		if("todousers" == $this->chrt_array['tables'][0])
			return true;
		if("todocomments" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
