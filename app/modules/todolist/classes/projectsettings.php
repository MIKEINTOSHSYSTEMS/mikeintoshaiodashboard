...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("todousers", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "todoboards" ] = array( "url" => "todoboards", "type" => 0 );
	$projectEntitiesReverse[ "todoboards" ] = "todoboards";
	$projectEntities[ "todocards" ] = array( "url" => "todocards", "type" => 0 );
	$projectEntitiesReverse[ "todocards" ] = "todocards";
	$projectEntities[ "todocategories" ] = array( "url" => "todocategories", "type" => 0 );
	$projectEntitiesReverse[ "todocategories" ] = "todocategories";
	$projectEntities[ "todolists" ] = array( "url" => "todolists", "type" => 0 );
	$projectEntitiesReverse[ "todolists" ] = "todolists";
	...
	$projectEntities[ "todogantt" ] = array( "url" => "todogantt", "type" => 1 );
	$projectEntitiesReverse[ "todogantt" ] = "todogantt";
	$projectEntities[ "Settings" ] = array( "url" => "settings", "type" => 1 );
	...
	$projectEntities[ "todousers" ] = array( "url" => "todousers", "type" => 0 );
	$projectEntitiesReverse[ "todousers" ] = "todousers";
	$projectEntities[ "todocomments" ] = array( "url" => "todocomments", "type" => 0 );
	$projectEntitiesReverse[ "todocomments" ] = "todocomments";
}
