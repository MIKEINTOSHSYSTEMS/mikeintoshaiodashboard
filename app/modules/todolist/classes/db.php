...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "calcalendar", "varname" => "project_at_localhost__calcalendar", "altvarname" => "calcalendar", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "calcategory", "varname" => "project_at_localhost__calcategory", "altvarname" => "calcategory", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "calfirstday", "varname" => "project_at_localhost__calfirstday", "altvarname" => "calfirstday", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "calglobals", "varname" => "project_at_localhost__calglobals", "altvarname" => "calglobals", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "calholidays", "varname" => "project_at_localhost__calholidays", "altvarname" => "calholidays", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "callocale", "varname" => "project_at_localhost__callocale", "altvarname" => "callocale", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "calperiod", "varname" => "project_at_localhost__calperiod", "altvarname" => "calperiod", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "calusers", "varname" => "project_at_localhost__calusers", "altvarname" => "calusers", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "calweekdays", "varname" => "project_at_localhost__calweekdays", "altvarname" => "calweekdays", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "todoboards", "varname" => "project_at_localhost__todoboards", "altvarname" => "todoboards", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "todocards", "varname" => "project_at_localhost__todocards", "altvarname" => "todocards", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "todocategories", "varname" => "project_at_localhost__todocategories", "altvarname" => "todocategories", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "todocomments", "varname" => "project_at_localhost__todocomments", "altvarname" => "todocomments", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "todolists", "varname" => "project_at_localhost__todolists", "altvarname" => "todolists", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "todousers", "varname" => "project_at_localhost__todousers", "altvarname" => "todousers", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		}
	}
