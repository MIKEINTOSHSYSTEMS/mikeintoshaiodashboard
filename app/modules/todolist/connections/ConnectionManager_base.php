...
class ConnectionManager_Base
{
	...
	{
		$connectionsIds = array();
		$connectionsIds["todoboards"] = "project_at_localhost";
		$connectionsIds["todocards"] = "project_at_localhost";
		$connectionsIds["todocategories"] = "project_at_localhost";
		$connectionsIds["todolists"] = "project_at_localhost";
		$connectionsIds["calcalendar"] = "project_at_localhost";
		$connectionsIds["calperiod"] = "project_at_localhost";
		$connectionsIds["calglobals"] = "project_at_localhost";
		$connectionsIds["calholidays"] = "project_at_localhost";
		$connectionsIds["calusers"] = "project_at_localhost";
		$connectionsIds["calweekdays"] = "project_at_localhost";
		$connectionsIds["calfirstday"] = "project_at_localhost";
		$connectionsIds["callocale"] = "project_at_localhost";
		$connectionsIds["todogantt"] = "project_at_localhost";
		$connectionsIds["Settings"] = "project_at_localhost";
		$connectionsIds["calcategory"] = "project_at_localhost";
		$connectionsIds["todousers"] = "project_at_localhost";
		$connectionsIds["todocomments"] = "project_at_localhost";
