...
function checkTableName($shortTName )
{
	...
	if ("todoboards" == $shortTName )
		return true;
	if ("todocards" == $shortTName )
		return true;
	if ("todocategories" == $shortTName )
		return true;
	if ("todolists" == $shortTName )
		return true;
	...
	if ("callocale" == $shortTName )
		return true;
	if ("todogantt" == $shortTName )
		return true;
	if ("settings" == $shortTName )
		return true;
	if ("calcategory" == $shortTName )
		return true;
	if ("todousers" == $shortTName )
		return true;
	if ("todocomments" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("todoboards");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("todocards");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("todocategories");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("todolists");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("todogantt");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("todousers");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("todocomments");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
function GetUserPermissionsStatic( $table )
{
	...
	if( $table=="todoboards" )
	{
		...
		{
						$extraPerm = 'M';
			return "EDSPIA".$extraPerm;
		}
//	default permissions
		return "ESPIAD".$extraPerm;
	}
	if( $table=="todocards" )
	{
		if( $sUserGroup=="admin" )
...
//	default permissions
		return "SPIAED".$extraPerm;
	}
	if( $table=="todocategories" )
	{
		if( $sUserGroup=="admin" )
		{
						$extraPerm = 'M';
...
//	default permissions
	...
	if( $table=="todocomments" )
	{
		if( $sUserGroup=="admin" )
		{
						$extraPerm = 'M';
			return "DESPIA".$extraPerm;
		}
//	default permissions
		return "SPIDEA".$extraPerm;
	}
