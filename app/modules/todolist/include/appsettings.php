...
$custom_labels["English"] = array();
	$custom_labels["English"]['boardname_start'] = "Welcome to ToDo List !";
	$custom_labels["English"]['listname_start1'] = "ToDo";
	$custom_labels["English"]['listname_start2'] = "Working";
	$custom_labels["English"]['listname_start3'] = "Done";
	$custom_labels["English"]['start_cardname1'] = "Run?";
	$custom_labels["English"]['start_cardname2'] = "Do Something!";
	$custom_labels["English"]['change_category'] = "Change Category";
	$custom_labels["English"]['close'] = "Close";
	$custom_labels["English"]['category'] = "Category";
	$custom_labels["English"]['delete_event'] = "Delete event?";
	$custom_labels["English"]['add_list'] = "Add list";
	$custom_labels["English"]['add_acard'] = "Add another card";
	$custom_labels["English"]['list_action'] = "List Action";
	$custom_labels["English"]['add_card'] = "Add Card";
	$custom_labels["English"]['copy_list'] = "Copy List";
	$custom_labels["English"]['rename_list'] = "Rename List";
	$custom_labels["English"]['delete_list'] = "Delete List";
	$custom_labels["English"]['card_action'] = "Card Action";
	$custom_labels["English"]['edit_card'] = "Edit Card";
	$custom_labels["English"]['view_card'] = "View Card";
	$custom_labels["English"]['assign_user'] = "Assign User";
	$custom_labels["English"]['copy_card'] = "Copy Card to";
	$custom_labels["English"]['move_card'] = "Move Card to";
	$custom_labels["English"]['delete_card'] = "Delete Card";
	$custom_labels["English"]['add_comments'] = "Comments";
	$custom_labels["English"]['comments'] = "Comments";
	$custom_labels["English"]['list_name'] = "List Name";
	$custom_labels["English"]['card_name'] = "Card Name";
	$custom_labels["English"]['realy_delete'] = "Do you really want to delete this card?";
	$custom_labels["English"]['invalid_message_1'] = "Invalid event date or time";
	$custom_labels["English"]['invalid_message_2'] = "Invalid event time";
	$custom_labels["English"]['invalid_message_3'] = "Invalid event end date or time";
	$custom_labels["English"]['day_of_week'] = "Select the day of the week";
	$custom_labels["English"]['please_select'] = "Please Select";
	$custom_labels["English"]['more'] = "More...";
	$custom_labels["English"]['total'] = "Total";
...
$globalSettings["LandingURL"] = "login.php?page=login_ToDoList";
$globalSettings["LandingPageId"] = "login_Project";

$globalSettings["ProjectLogo"] = array();
$globalSettings["ProjectLogo"]["English"] = "<span><img src=\"images/icons48.png\" width=20px>&nbsp;&nbsp;ToDo List</span>";
...
$globalSettings["usersDatasourceTable"] = "todousers";


$globalSettings["jwtSecret"] = "dhCMRoOeOm4IXxybMVf5";
...
$projectBuildKey = "1814_1670422958";
$wizardBuildKey = "39925";
$projectBuildNumber = "1814";
...
$tableCaptions["English"]["todoboards"] = "Boards";
$tableCaptions["English"]["todocards"] = "Cards";
$tableCaptions["English"]["todocategories"] = "Categories";
$tableCaptions["English"]["todolists"] = "Lists";
$tableCaptions["English"][""] = "";
$tableCaptions["English"]["calcalendar"] = "Calendar";
$tableCaptions["English"]["calperiod"] = "Calperiod";
$tableCaptions["English"]["calglobals"] = "Globals Settings";
$tableCaptions["English"]["calholidays"] = "Holidays";
$tableCaptions["English"]["calusers"] = "Calusers";
$tableCaptions["English"]["calweekdays"] = "Calweekdays";
$tableCaptions["English"]["calfirstday"] = "Calfirstday";
$tableCaptions["English"]["callocale"] = "Callocale";
$tableCaptions["English"]["todogantt"] = "GANTT";
$tableCaptions["English"]["Settings"] = "Settings";
$tableCaptions["English"]["calcategory"] = "Calcategory";
$tableCaptions["English"]["todousers"] = "Todousers";
$tableCaptions["English"]["todocomments"] = "Comments";
...
include_once(getabspath("include/todo_calendar_functions.php"));
include_once(getabspath("include/todo_calendar_holidays.php"));
...
$calendarSettings["calendarTable"] = "todocards"; 
$calendarSettings["calendarKeys"]["calendarid"] = "id"; 
$calendarSettings["calendarFields"]["calendarDateField"] = "duedate";
$calendarSettings["calendarFields"]["calendarSubject"] = "cardname";
$calendarSettings["calendarFields"]["calendarCategory"] = "categoryid";
$calendarSettings["calendarFields"]["calendarRecurType"] = "listid";
$calendarSettings["calendarFields"]["calendarDescription"] = "boardid";
$calendarSettings["calendarFields"]["calendarOwnerID"] = "ownerid";
