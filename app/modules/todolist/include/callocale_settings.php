...
$tdatacallocale[".pagesByType"] = my_json_decode( "{\"search\":[\"search\"]}" );
$tdatacallocale[".originalPagesByType"] = $tdatacallocale[".pagesByType"];
$tdatacallocale[".pages"] = types2pages( my_json_decode( "{\"search\":[\"search\"]}" ) );
$tdatacallocale[".originalPages"] = $tdatacallocale[".pages"];
$tdatacallocale[".defaultPages"] = my_json_decode( "{\"search\":\"search\"}" );
...
$tdatacallocale[".badgeColor"] = "BC8F8F";
