...
c=a?this.NI():"MERQ Charts - JavaScript Charts designed to be embedded and integrated{{anychart-version}}",$.me(this.g,{href:a?this.QI():"https://merqconsultancy.org",title:c.replace("{{anychart-version}}",b),target:"_blank"}),$.me(this.b,{alt:a?this.OI():"MERQ Charts - JavaScript Charts"}),this.I(Mk));this.J(Nk)&&(a=a?this.text():"Dereja M&E Chart",$.Ne(this.D,a),this.I(Nk));if(this.J(Ok)){if(a=Sk(this)?this.AE():Qk()){if(this.O=a,b=Tg($.Uf()))$.Bd(b,"complete",this.r1,!1,this),$.Bd(b,
...
defaultNoDataLabel:{padding:{},disablePointerEvents:!1,enabled:!1,background:{zIndex:0,enabled:!1,visible:!1,disablePointerEvents:!1},fontFamily:"Arial",fontColor:"black",fontWeight:"bold",fontSize:15,position:"center",anchor:"center",zIndex:999999,text:"No data."},stageCredits:{text:"AnyChart",url:"https://www.anychart.com/?utm_source=registered",alt:"MERQ Charts - JavaScript Charts designed to be embedded and integrated{{anychart-version}}",imgAlt:"MERQ Charts - JavaScript Charts",logoSrc:"https://static.anychart.com/logo.png"},
