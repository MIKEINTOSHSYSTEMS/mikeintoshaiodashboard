...
class ConnectionManager_Base
{
	...
	{
		$connectionsIds = array();
		$connectionsIds["doc_files"] = "project_at_localhost";
		$connectionsIds["doc_settings"] = "project_at_localhost";
		$connectionsIds["doc_users"] = "project_at_localhost";
		$connectionsIds["share_type"] = "project_at_localhost";
		$connectionsIds["Add folder"] = "project_at_localhost";
		$connectionsIds["Share"] = "project_at_localhost";
		$connectionsIds["doc_savemethod"] = "project_at_localhost";
		$connectionsIds["doc_files_versions"] = "project_at_localhost";
