...
Runner.lang.customlabels = {
	...
	// custom labels
	CUSTOM_LABEL_login_header: 'Use <b>admin@test.com/admin</b> to login',
	CUSTOM_LABEL_current_version: 'Current version',
	CUSTOM_LABEL_version: 'Version',
	CUSTOM_LABEL_file_sent: 'File was sent to %user%',
	CUSTOM_LABEL_were_deleted: '%count% file(s) were deleted',
	CUSTOM_LABEL_remove: 'Remove',
	CUSTOM_LABEL_drop_file: 'Drop files here to upload',
	CUSTOM_LABEL_download: 'Download',
	CUSTOM_LABEL_delete: 'Delete',
	CUSTOM_LABEL_want_to_delete: 'Do you want to delete this file?',
	CUSTOM_LABEL_dest_file_exist: 'The destination already has a file named',
	CUSTOM_LABEL_dest_replace_file: 'Replace the file in the destination',
	CUSTOM_LABEL_skip_file: 'Skip this file',
	CUSTOM_LABEL_save_as: 'Save as',
	CUSTOM_LABEL_close: 'Close',
	CUSTOM_LABEL_files_added: 'File(s) not added',
	CUSTOM_LABEL_change_settings: 'If you change this setting you won\'t be able to see existing files. Continue?',
	CUSTOM_LABEL_user_shared_file: '%username% shared a %file_type% with you',
	CUSTOM_LABEL_noty_sent: 'Notification sent to $email',
	CUSTOM_LABEL_read_write: 'Read / Write',
	CUSTOM_LABEL_upload_path_exist: 'Upload folder %upload_path% not exist',
	CUSTOM_LABEL_select_all: 'Select all',
	CUSTOM_LABEL_downloads: 'Downloads',
	CUSTOM_LABEL_all_versions: 'All versions',
	CUSTOM_LABEL_created: 'Created',
	CUSTOM_LABEL_files: 'file(s)',
	CUSTOM_LABEL_folders: 'folder(s)',
	CUSTOM_LABEL_share: 'Share',
	CUSTOM_LABEL_send: 'Send',
	CUSTOM_LABEL_create_folder: 'Create folder',
	CUSTOM_LABEL_save: 'Save',
	CUSTOM_LABEL_to: 'To',
	CUSTOM_LABEL_subj: 'Subject',
	CUSTOM_LABEL_body: 'Body',
	CUSTOM_LABEL_send_file: 'Send file',
	CUSTOM_LABEL_recipient: 'Recipient not selected',
