...
class tDAL
{
	var $tblproject_at_localhost__doc_files;
	var $tblproject_at_localhost__doc_files_versions;
	var $tblproject_at_localhost__doc_savemethod;
	var $tblproject_at_localhost__doc_settings;
	var $tblproject_at_localhost__doc_users;
	var $tblproject_at_localhost__share_type;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "doc_files", "varname" => "project_at_localhost__doc_files", "altvarname" => "doc_files", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "doc_files_versions", "varname" => "project_at_localhost__doc_files_versions", "altvarname" => "doc_files_versions", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "doc_savemethod", "varname" => "project_at_localhost__doc_savemethod", "altvarname" => "doc_savemethod", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "doc_settings", "varname" => "project_at_localhost__doc_settings", "altvarname" => "doc_settings", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "doc_users", "varname" => "project_at_localhost__doc_users", "altvarname" => "doc_users", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "share_type", "varname" => "project_at_localhost__share_type", "altvarname" => "share_type", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
	}
