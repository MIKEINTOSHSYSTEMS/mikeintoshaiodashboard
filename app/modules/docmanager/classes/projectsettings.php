...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("doc_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "doc_files" ] = array( "url" => "doc_files", "type" => 0 );
	$projectEntitiesReverse[ "doc_files" ] = "doc_files";
	$projectEntities[ "doc_settings" ] = array( "url" => "doc_settings", "type" => 0 );
	$projectEntitiesReverse[ "doc_settings" ] = "doc_settings";
	$projectEntities[ "doc_users" ] = array( "url" => "doc_users", "type" => 0 );
	$projectEntitiesReverse[ "doc_users" ] = "doc_users";
	$projectEntities[ "share_type" ] = array( "url" => "share_type", "type" => 0 );
	$projectEntitiesReverse[ "share_type" ] = "share_type";
	$projectEntities[ "Add folder" ] = array( "url" => "Add_folder", "type" => 1 );
	$projectEntitiesReverse[ "Add_folder" ] = "Add folder";
	$projectEntities[ "Share" ] = array( "url" => "Share", "type" => 1 );
	$projectEntitiesReverse[ "Share" ] = "Share";
	$projectEntities[ "doc_savemethod" ] = array( "url" => "doc_savemethod", "type" => 0 );
	$projectEntitiesReverse[ "doc_savemethod" ] = "doc_savemethod";
	$projectEntities[ "doc_files_versions" ] = array( "url" => "doc_files_versions", "type" => 0 );
	$projectEntitiesReverse[ "doc_files_versions" ] = "doc_files_versions";
}
