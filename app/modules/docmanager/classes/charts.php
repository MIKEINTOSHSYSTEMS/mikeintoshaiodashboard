...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("doc_files" == $this->chrt_array['tables'][0])
			return true;
		if("doc_settings" == $this->chrt_array['tables'][0])
			return true;
		if("doc_users" == $this->chrt_array['tables'][0])
			return true;
		if("share_type" == $this->chrt_array['tables'][0])
			return true;
		if("doc_files" == $this->chrt_array['tables'][0])
			return true;
		if("doc_files" == $this->chrt_array['tables'][0])
			return true;
		if("doc_savemethod" == $this->chrt_array['tables'][0])
			return true;
		if("doc_files_versions" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
