...
$custom_labels["English"] = array();
	$custom_labels["English"]['please_select_text'] = "Please select...";
	$custom_labels["English"]['sql_field_name'] = "SQL Field Name";
	$custom_labels["English"]['not_set_path_message'] = "Path to pdftk.exe is not set";
	$custom_labels["English"]['save_record_message'] = "Save the record to display the list of fields";
	$custom_labels["English"]['no_sql_to_test'] = "No SQL Query to test. Enter some.";
	$custom_labels["English"]['makePdf'] = "Make PDF";
	$custom_labels["English"]['completed_pdf_form'] = "Completed PDF Form";
...
$globalSettings["LandingPageId"] = "menu_PDFForms";

$globalSettings["ProjectLogo"] = array();
$globalSettings["ProjectLogo"]["English"] = "PDFForms";
...
$globalSettings["usersDatasourceTable"] = "pdf_users";


$globalSettings["jwtSecret"] = "cqZclnupq1kVy2j5f4v5";
...
$projectBuildKey = "440_1669905548";
...
$tableCaptions["English"]["pdf_formfields"] = "Fields";
$tableCaptions["English"]["pdf_forms"] = "Pdf Forms";
$tableCaptions["English"]["pdf_test"] = "Pdf Test";
$tableCaptions["English"]["pdf_sqlfields"] = "Pdf Sqlfields";
$tableCaptions["English"]["pdf_formoptions"] = "Settings";
$tableCaptions["English"]["pdf_users"] = "Pdf Users";
...
require_once("include/pdfform_functions.php");
$rs = DB::Select("pdf_formoptions");
if($data = $rs->fetchAssoc()){
	if(strpos(php_uname(),"Windows")!==false && !$data["pdfpath"]){
		DB::Update("pdf_formoptions", array("pdfpath"=>"pdftk/pdftk.exe"),array("id"=>$data["id"]));
	}
}
;
