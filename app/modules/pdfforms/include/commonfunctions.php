...
function checkTableName($shortTName )
{
	...
	if ("pdf_formfields" == $shortTName )
		return true;
	if ("pdf_forms" == $shortTName )
		return true;
	if ("pdf_test1" == $shortTName )
		return true;
	if ("pdf_sqlfields" == $shortTName )
		return true;
	if ("pdf_formoptions" == $shortTName )
		return true;
	if ("pdf_users" == $shortTName )
		return true;
	return false;
}
...
function GetTablesList($pdfMode = false)
{
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("pdf_formfields");
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("pdf_forms");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("pdf_test");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("pdf_sqlfields");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("pdf_formoptions");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
	...
	$tableAvailable = true;
	if( $checkPermissions ) {
		$strPerm = GetUserPermissions("pdf_users");
		$tableAvailable = ( strpos($strPerm, "P") !== false
			|| $pdfMode && strpos($strPerm, "S") !== false );
	}
	if( $tableAvailable ) {
...
//	default permissions
	...
	if( $table=="pdf_sqlfields" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
	if( $table=="pdf_formoptions" )
	{
//	default permissions
		return "ADESPI".$extraPerm;
	}
