...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("pdf_formfields" == $this->chrt_array['tables'][0])
			return true;
		if("pdf_forms" == $this->chrt_array['tables'][0])
			return true;
		if("pdf_test" == $this->chrt_array['tables'][0])
			return true;
		if("pdf_sqlfields" == $this->chrt_array['tables'][0])
			return true;
		if("pdf_formoptions" == $this->chrt_array['tables'][0])
			return true;
		if("pdf_users" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
