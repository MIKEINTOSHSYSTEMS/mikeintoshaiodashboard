...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "pdf_formfields", "varname" => "project_at_localhost__pdf_formfields", "altvarname" => "pdf_formfields", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "pdf_formoptions", "varname" => "project_at_localhost__pdf_formoptions", "altvarname" => "pdf_formoptions", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "pdf_forms", "varname" => "project_at_localhost__pdf_forms", "altvarname" => "pdf_forms", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "pdf_sqlfields", "varname" => "project_at_localhost__pdf_sqlfields", "altvarname" => "pdf_sqlfields", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "pdf_test", "varname" => "project_at_localhost__pdf_test", "altvarname" => "pdf_test", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "pdf_users", "varname" => "project_at_localhost__pdf_users", "altvarname" => "pdf_users", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		}
	}
