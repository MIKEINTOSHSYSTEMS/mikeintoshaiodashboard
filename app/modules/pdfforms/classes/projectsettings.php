...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("pdf_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "pdf_formfields" ] = array( "url" => "pdf_formfields", "type" => 0 );
	$projectEntitiesReverse[ "pdf_formfields" ] = "pdf_formfields";
	$projectEntities[ "pdf_forms" ] = array( "url" => "pdf_forms", "type" => 0 );
	$projectEntitiesReverse[ "pdf_forms" ] = "pdf_forms";
	$projectEntities[ "pdf_test" ] = array( "url" => "pdf_test1", "type" => 0 );
	$projectEntitiesReverse[ "pdf_test1" ] = "pdf_test";
	$projectEntities[ "pdf_sqlfields" ] = array( "url" => "pdf_sqlfields", "type" => 0 );
	$projectEntitiesReverse[ "pdf_sqlfields" ] = "pdf_sqlfields";
	$projectEntities[ "pdf_formoptions" ] = array( "url" => "pdf_formoptions", "type" => 0 );
	$projectEntitiesReverse[ "pdf_formoptions" ] = "pdf_formoptions";
	$projectEntities[ "pdf_users" ] = array( "url" => "pdf_users", "type" => 0 );
	$projectEntitiesReverse[ "pdf_users" ] = "pdf_users";
}
