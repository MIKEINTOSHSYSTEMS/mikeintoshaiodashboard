...
class ConnectionManager_Base
{
	...
	{
		$connectionsIds = array();
		$connectionsIds["pdf_formfields"] = "project_at_localhost";
		$connectionsIds["pdf_forms"] = "project_at_localhost";
		$connectionsIds["pdf_test"] = "project_at_localhost";
		$connectionsIds["pdf_sqlfields"] = "project_at_localhost";
		$connectionsIds["pdf_formoptions"] = "project_at_localhost";
		$connectionsIds["pdf_users"] = "project_at_localhost";
