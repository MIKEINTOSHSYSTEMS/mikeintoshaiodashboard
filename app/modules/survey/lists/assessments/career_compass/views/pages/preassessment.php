...
<head>
    ...
    <title>Career Compass Pre Assessment</title>
    <style>
        table {
            width: 100%;
...
<body>
    <h1>Career Compass Pre Assessment Submissions</h1>
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://derejadev.merqconsultancy.org/backend/forms/api/v1/forms/14/submissions',
