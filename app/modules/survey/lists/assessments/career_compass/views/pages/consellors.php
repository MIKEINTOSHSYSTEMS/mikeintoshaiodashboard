...
<head>
    ...
    <title>Career Compass Consellors Satisfaction</title>
    <style>
        table {
            width: 100%;
...
<body>
    <h1>Career Compass Consellors Assessment Satisfaction Submissions</h1>
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://derejadev.merqconsultancy.org/backend/forms/api/v1/forms/13/submissions',
