...
<head>
    ...
    <title>CANDIDATES Form Submissions</title>
    <style>
        table {
            width: 100%;
...
<body>
    <h1>CANDIDATES Form Submissions</h1>
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://derejadev.merqconsultancy.org/backend/forms/api/v1/forms/1/submissions',
