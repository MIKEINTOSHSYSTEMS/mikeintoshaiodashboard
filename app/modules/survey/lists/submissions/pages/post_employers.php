...
<head>
    ...
    <title>POST-ASSESSMENT EMPLOYERS' FEEDBACK Form Submissions</title>
    <style>
        table {
            width: 100%;
...
<body>
    <h1>POST-ASSESSMENT EMPLOYERS' FEEDBACK Form Submissions</h1>
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://derejadev.merqconsultancy.org/backend/forms/api/v1/forms/9/submissions',
    ...
    <script>
        ...
        function exportSelectedRows() {
            ...
            link.setAttribute("download", "post_employers.csv");
