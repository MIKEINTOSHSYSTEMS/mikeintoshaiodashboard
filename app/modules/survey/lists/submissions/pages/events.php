...
<body>
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://derejadev.merqconsultancy.org/backend/forms/api/v1/forms/2/submissions',
    ...
    <script>
        ...
        function exportSelectedRows() {
            ...
            link.setAttribute("download", "events_submissions.csv");
