...
<head>
    ...
    <title>POST-ASSESSMENT CANDIDATES' SURVEY Form Submissions</title>
    <style>
        table {
            width: 100%;
...
<body>
    <h1>POST-ASSESSMENT CANDIDATES' SURVEY Form Submissions</h1>
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://derejadev.merqconsultancy.org/backend/forms/api/v1/forms/8/submissions',
