...
<head>
    ...
    <title>PRE-ASSESSMENT CANDIDATES' SURVEY Form Submissions</title>
    <style>
        table {
            width: 100%;
...
<body>
    <h1>PRE-ASSESSMENT CANDIDATES' SURVEY Form Submissions</h1>
    ...
    curl_setopt_array($curl, array(
        CURLOPT_URL => 'https://derejadev.merqconsultancy.org/backend/forms/api/v1/forms/6/submissions',
    ...
    <script>
        ...
        function exportSelectedRows() {
            ...
            link.setAttribute("download", "pre_candidates.csv");
