...
$custom_labels["English"] = array();
	$custom_labels["English"]['is_not_active'] = "This survey currently is not active. Please try again later.";
	$custom_labels["English"]['is_not_yet_started'] = "This survey is not yet started";
	$custom_labels["English"]['no_longer_available'] = "This survey is no longer available";
	$custom_labels["English"]['next'] = "Next";
	$custom_labels["English"]['submit'] = "Submit";
	$custom_labels["English"]['questions'] = "There are %count% questions in this survey.";
	$custom_labels["English"]['question'] = "There is %count% question in this survey.";
	$custom_labels["English"]['save_for_later'] = "Save for later";
	$custom_labels["English"]['prev'] = "Prev";
	$custom_labels["English"]['name'] = "Group 1";
	$custom_labels["English"]['description'] = "Group 1 Description";
	$custom_labels["English"]['email'] = "Email";
	$custom_labels["English"]['send_email'] = "Send Email";
	$custom_labels["English"]['TEXT_FIELD_DATE'] = "Field should be a valid date";
	$custom_labels["English"]['TEXT_ERROR'] = "Error occurred";
	$custom_labels["English"]['TEXT_FIELD_ISINTEGER'] = "Field should be a integer";
	$custom_labels["English"]['TEXT_REGEXP'] = "This question must be answered correctly";
	$custom_labels["English"]['TEXT_FIELD_REQUIRED'] = "Required field";
	$custom_labels["English"]['TEXT_FIELD_NUMBER'] = "Field should be a valid number";
	$custom_labels["English"]['add_files'] = "Add files";
	$custom_labels["English"]['cancel'] = "Cancel";
	$custom_labels["English"]['delete'] = "Delete";
	$custom_labels["English"]['please_select'] = "Please select";
	$custom_labels["English"]['other'] = "Other";
	$custom_labels["English"]['no_answer'] = "No answer";
	$custom_labels["English"]['other_answer'] = "Other answer";
	$custom_labels["English"]['start'] = "Start";
	$custom_labels["English"]['cancel'] = "Cancel";
	$custom_labels["English"]['delete'] = "Delete";
	$custom_labels["English"]['click_to_show_description'] = "Click to show description";
	$custom_labels["English"]['answer'] = "Answer";
	$custom_labels["English"]['count'] = "Count";
	$custom_labels["English"]['percentage'] = "Percentage";
	$custom_labels["English"]['no_calculate'] = "No calculate";
...
$globalSettings["LandingPageId"] = "menu_Survey";

$globalSettings["ProjectLogo"] = array();
$globalSettings["ProjectLogo"]["English"] = "Survey";
...
$globalSettings["usersDatasourceTable"] = "sv_users";


$globalSettings["jwtSecret"] = "eJM4mv5l0UmUkQrrtTND";
...
$projectBuildKey = "2565_1670421081";
$wizardBuildKey = "39925";
$projectBuildNumber = "2565";
...
$tableCaptions["English"]["response"] = "Response";
$tableCaptions["English"][""] = "";
$tableCaptions["English"]["sv_questions"] = "Questions";
$tableCaptions["English"]["sv_groups"] = "Groups";
$tableCaptions["English"]["sv_users"] = "Users";
$tableCaptions["English"]["sv_surveys"] = "Surveys";
$tableCaptions["English"]["sv_answer_options"] = "Answer Options";
$tableCaptions["English"]["sv_question_details"] = "Answers";
$tableCaptions["English"]["sv_scenarios"] = "Scenarios";
$tableCaptions["English"]["sv_question_types"] = "Sv Question Types";
$tableCaptions["English"]["sv_helpquestion_viewtype"] = "Sv Helpquestion Viewtype";
$tableCaptions["English"]["sv_survey_formats"] = "Sv Survey Formats";
$tableCaptions["English"]["sv_format_date"] = "Sv Format Date";
$tableCaptions["English"]["sv_report"] = "Sv Report";
...
include_once(getabspath("survey_functions.php"));
if(!$_SESSION["UserID"] && postvalue("sid") && Security::isLoggedIn())
