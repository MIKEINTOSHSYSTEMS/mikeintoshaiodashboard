...
class ConnectionManager_Base
{
	...
	{
		$connectionsIds = array();
		$connectionsIds["response"] = "project_at_localhost";
		$connectionsIds["sv_questions"] = "project_at_localhost";
		$connectionsIds["sv_groups"] = "project_at_localhost";
		$connectionsIds["sv_users"] = "project_at_localhost";
		$connectionsIds["sv_surveys"] = "project_at_localhost";
		$connectionsIds["sv_answer_options"] = "project_at_localhost";
		$connectionsIds["sv_question_details"] = "project_at_localhost";
		$connectionsIds["sv_scenarios"] = "project_at_localhost";
		$connectionsIds["sv_question_types"] = "project_at_localhost";
		$connectionsIds["sv_helpquestion_viewtype"] = "project_at_localhost";
		$connectionsIds["sv_survey_formats"] = "project_at_localhost";
		$connectionsIds["sv_format_date"] = "project_at_localhost";
		$connectionsIds["sv_report"] = "project_at_localhost";
