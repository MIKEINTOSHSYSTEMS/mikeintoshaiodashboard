...
class DB
{
	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		{
			$dalTables[$conn->connId][] = array("name" => "sv_answer_options", "varname" => "project_at_localhost__sv_answer_options", "altvarname" => "sv_answer_options", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_conditions", "varname" => "project_at_localhost__sv_conditions", "altvarname" => "sv_conditions", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_format_date", "varname" => "project_at_localhost__sv_format_date", "altvarname" => "sv_format_date", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_groups", "varname" => "project_at_localhost__sv_groups", "altvarname" => "sv_groups", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_helpquestion_viewtype", "varname" => "project_at_localhost__sv_helpquestion_viewtype", "altvarname" => "sv_helpquestion_viewtype", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_question_details", "varname" => "project_at_localhost__sv_question_details", "altvarname" => "sv_question_details", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_question_types", "varname" => "project_at_localhost__sv_question_types", "altvarname" => "sv_question_types", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_questions", "varname" => "project_at_localhost__sv_questions", "altvarname" => "sv_questions", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_report", "varname" => "project_at_localhost__sv_report", "altvarname" => "sv_report", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_scenarios", "varname" => "project_at_localhost__sv_scenarios", "altvarname" => "sv_scenarios", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_survey", "varname" => "project_at_localhost__sv_survey", "altvarname" => "sv_survey", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_survey_formats", "varname" => "project_at_localhost__sv_survey_formats", "altvarname" => "sv_survey_formats", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_surveys", "varname" => "project_at_localhost__sv_surveys", "altvarname" => "sv_surveys", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "sv_users", "varname" => "project_at_localhost__sv_users", "altvarname" => "sv_users", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		}
	}
