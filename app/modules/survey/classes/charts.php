...
//				$this->strLabel = $params['name'];
	...
	protected function isProjectDB()
	{
		...
		if("sv_surveys" == $this->chrt_array['tables'][0])
			return true;
		if("sv_questions" == $this->chrt_array['tables'][0])
			return true;
		if("sv_groups" == $this->chrt_array['tables'][0])
			return true;
		if("sv_users" == $this->chrt_array['tables'][0])
			return true;
		if("sv_surveys" == $this->chrt_array['tables'][0])
			return true;
		if("sv_answer_options" == $this->chrt_array['tables'][0])
			return true;
		if("sv_question_details" == $this->chrt_array['tables'][0])
			return true;
		if("sv_scenarios" == $this->chrt_array['tables'][0])
			return true;
		if("sv_question_types" == $this->chrt_array['tables'][0])
			return true;
		if("sv_helpquestion_viewtype" == $this->chrt_array['tables'][0])
			return true;
		if("sv_survey_formats" == $this->chrt_array['tables'][0])
			return true;
		if("sv_format_date" == $this->chrt_array['tables'][0])
			return true;
		if("sv_report" == $this->chrt_array['tables'][0])
			return true;
		return false;
	}
