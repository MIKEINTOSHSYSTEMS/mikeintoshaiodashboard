...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("sv_users", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "response" ] = array( "url" => "response", "type" => 1 );
	$projectEntitiesReverse[ "response" ] = "response";
	$projectEntities[ "sv_questions" ] = array( "url" => "sv_questions", "type" => 1 );
	$projectEntitiesReverse[ "sv_questions" ] = "sv_questions";
	$projectEntities[ "sv_groups" ] = array( "url" => "sv_groups", "type" => 1 );
	$projectEntitiesReverse[ "sv_groups" ] = "sv_groups";
	$projectEntities[ "sv_users" ] = array( "url" => "sv_users", "type" => 0 );
	$projectEntitiesReverse[ "sv_users" ] = "sv_users";
	$projectEntities[ "sv_surveys" ] = array( "url" => "sv_surveys", "type" => 1 );
	$projectEntitiesReverse[ "sv_surveys" ] = "sv_surveys";
	$projectEntities[ "sv_answer_options" ] = array( "url" => "sv_answer_options", "type" => 1 );
	$projectEntitiesReverse[ "sv_answer_options" ] = "sv_answer_options";
	$projectEntities[ "sv_question_details" ] = array( "url" => "sv_question_details", "type" => 1 );
	$projectEntitiesReverse[ "sv_question_details" ] = "sv_question_details";
	$projectEntities[ "sv_scenarios" ] = array( "url" => "sv_scenarios", "type" => 1 );
	$projectEntitiesReverse[ "sv_scenarios" ] = "sv_scenarios";
	$projectEntities[ "sv_question_types" ] = array( "url" => "sv_question_types", "type" => 1 );
	$projectEntitiesReverse[ "sv_question_types" ] = "sv_question_types";
	$projectEntities[ "sv_helpquestion_viewtype" ] = array( "url" => "sv_helpquestion_viewtype", "type" => 1 );
	$projectEntitiesReverse[ "sv_helpquestion_viewtype" ] = "sv_helpquestion_viewtype";
	$projectEntities[ "sv_survey_formats" ] = array( "url" => "sv_survey_formats", "type" => 1 );
	$projectEntitiesReverse[ "sv_survey_formats" ] = "sv_survey_formats";
	$projectEntities[ "sv_format_date" ] = array( "url" => "sv_format_date", "type" => 1 );
	$projectEntitiesReverse[ "sv_format_date" ] = "sv_format_date";
	$projectEntities[ "sv_report" ] = array( "url" => "sv_report", "type" => 1 );
	$projectEntitiesReverse[ "sv_report" ] = "sv_report";
}
