...
class tDAL
{
	...
	var $tblproject_at_localhost__mtmeetings;
	var $tblproject_at_localhost__mtsettings;
	var $tblproject_at_localhost__mttimezone;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		...
		$this->lstTables[] = array("name" => "mtmeetings", "varname" => "project_at_localhost__mtmeetings", "altvarname" => "mtmeetings", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "mtsettings", "varname" => "project_at_localhost__mtsettings", "altvarname" => "mtsettings", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		$this->lstTables[] = array("name" => "mttimezone", "varname" => "project_at_localhost__mttimezone", "altvarname" => "mttimezone", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
	}
