...
(function ($) {
    ...
    $.ui_timepickr = {
        ...
        plugin: {
            add: function (module, option, set) {
                var proto = $.ui_timepickr[module].prototype;
                for (var i in set) {
        ...
        cssCache: {},
        css: function (name) {
            if ($.ui_timepickr.cssCache[name]) {
                return $.ui_timepickr.cssCache[name];
            }
            var tmp = $('<div class="ui-gen"></div>').addClass(name).css({
                position: 'absolute',
                top: '-5000px',
                left: '-5000px',
                display: 'block'
            }).appendTo('body');
            $.ui_timepickr.cssCache[name] = !! ((!(/auto|default/).test(tmp.css('cursor')) || (/^[1-9]/).test(tmp.css('height')) || (/^[1-9]/).test(tmp.css('width')) || !(/none/).test(tmp.css('backgroundImage')) || !(/transparent|rgba\(0, 0, 0, 0\)/).test(tmp.css('backgroundColor'))));
            try {
        ...
        isOver: function (y, x, top, left, height, width) {
            return $.ui_timepickr.isOverAxis(y, top, height) && $.ui_timepickr.isOverAxis(x, left, width);
        },
        keyCode: {
            BACKSPACE: 8,
            CAPS_LOCK: 20,
	...
	// deprecated
	$.ui_timepickr.ie = !!/msie [\w.]+/.exec( navigator.userAgent.toLowerCase() );
    ...
    $.fn.extend({
        ...
        scrollParent: function () {
            var scrollParent;
            if (($.ui_timepickr.ie && (/(static|relative)/).test(this.css('position'))) || (/absolute/).test(this.css('position'))) {
    ...
    $.widget_timepickr = function (name, prototype) {
        ...
        $[namespace][name] = function (element, options) {
            ...
            this.options = $.extend({}, $.widget_timepickr.defaults, $[namespace][name].defaults, $.metadata && $.metadata.get(element)[name], options);
        ...
        $[namespace][name].prototype = $.extend({}, $.widget_timepickr.prototype, prototype);
        $[namespace][name].getterSetter = 'option';
    };
    $.widget_timepickr.prototype = {
        _init: function () {},
        destroy: function () {
    ...
    $.ui_timepickr.mouse = {
        ...
        _mouseDestroy: function () {
            ...
            ($.ui_timepickr.ie && this.element.attr('unselectable', this._mouseUnselectable));
        },
        ...
        _mouseMove: function (event) {
            if ($.ui_timepickr.ie && !event.button) {
...
(function($){
	...
	$.extend({ 
        ...
        pxToEm: function(i, settings){
            ...
            if (settings.scope == 'body' && $.ui_timepickr.ie && (parseFloat($('body').css('font-size')) / getWindowWidth()).toFixed(1) > 0.0) {
...
$.widget_timepickr('ui_timepickr.timepickr', {
    plugins: {},
    _init: function() {
        this._dom = {
    ...
    _trigger: function(type, e, ui) {
        var ui = ui || this;
        $.ui_timepickr.plugin.call(this, type, [e, ui]);
        return $.widget_timepickr.prototype._trigger.call(this, type, e, ui);
    },
    ...
    _addRow: function(range, format, className, insertAfter) {
        ...
        if ($(row).hasClass('hours')){
        	h = 10;
        } else {
        	h = $('li',row).length;
        }

        $(row).css("height",h =(22 * Math.ceil(h / 10) +6) + "px" );
    ...
    _setVal: function(val) {
        ...
        if (val.h || val.m || val.s) { //Runner fix
    ...
    _formatVal: function(ival) {
        ...
        if (this.options.seconds){
        	val.f = val.c === 12 && this.options.format12sec || this.options.format24sec;
        } else {
...
$.extend($.ui_timepickr.timepickr, {
    ...
    defaults:    {
        ...
        format12sec:    '{h:02.d}:{m:02.d}:{s:02.d}  {z:s}',
        format24sec:    '{h:02.d}:{m:02.d}:{s:02.d}',
...
$.ui_timepickr.plugin.add('timepickr', 'core', {
...
$.ui_timepickr.plugin.add('timepickr', 'hours', {
...
$.ui_timepickr.plugin.add('timepickr', 'minutes', {
    initialize: function(e, ui) {
...
$.ui_timepickr.plugin.add('timepickr', 'seconds', {
    initialize: function(e, ui) {
...
$.ui_timepickr.plugin.add('timepickr', 'val', {
    initialized: function(e, ui) {
        ui._setVal(ui.options.val);
    }
});

$.ui_timepickr.plugin.add('timepickr', 'updateLive', {
    refresh: function(e, ui) {
        ui._setVal();
    }
});

$.ui_timepickr.plugin.add('timepickr', 'resetOnBlur', {
    initialized: function(e, ui) {
...
$.ui_timepickr.plugin.add('timepickr', 'handle', {
    initialized: function(e, ui) {
...
$.ui_timepickr.plugin.add('timepickr', 'keyboardnav', {
    initialized: function(e, ui) {
        ui.element
...
Time.prototype.getTime    = function()           { return $.format(this.f, {h: this.h, m: this.m, s: this.s, z: this.z}); };
