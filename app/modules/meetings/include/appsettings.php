...
$custom_labels["English"] = array();
	...
	$custom_labels["English"]['fill_all_required_settings'] = "Fill all required settings";
	$custom_labels["English"]['fillSettingAdmin'] = "Fill all required <a href='%url%'>settings</a> before you can create meetings";
	$custom_labels["English"]['fillSettingNoAdmin'] = "Fill all required settings before you can create meetings";
	$custom_labels["English"]['errorMessage'] = "Error : %description% <br>Please redirect to <a href='%redirect_uri%'>%redirect_uri%</a>";
	$custom_labels["English"]['deleteEvent'] = "Delete event?";
	$custom_labels["English"]['invalid_event_date'] = "Invalid event date";
	$custom_labels["English"]['invalid_event_date_or_time'] = "Invalid event date or time";
	$custom_labels["English"]['invalid_event_time'] = "Invalid event time";
	$custom_labels["English"]['keyfield_not_found'] = "Key field not found,<br> Add ";
	$custom_labels["English"]['more'] = "More... ";
	$custom_labels["English"]['total'] = "Total";
	$custom_labels["English"]['select_the_day_of_the_week'] = "Select the day of the week";
...
$globalSettings["LandingPageId"] = "menu_Meetings2";

$globalSettings["ProjectLogo"] = array();
$globalSettings["ProjectLogo"]["English"] = "Meetings";
...
$globalSettings["usersDatasourceTable"] = "calusers";


$globalSettings["jwtSecret"] = "85NestddYz4eSMCVOmSA";
...
$projectBuildKey = "872_1669886543";
$wizardBuildKey = "39925";
$projectBuildNumber = "872";
...
$tableCaptions["English"]["mtsettings"] = "Settings";
$tableCaptions["English"]["mtmeetings"] = "Meetings";
$tableCaptions["English"]["mttimezone"] = "Timezone";
...
include_once(getabspath("include/mt_calendar_functions.php"));
include_once(getabspath("include/mt_calendar_holidays.php"));
...
$calendarSettings["calendarTable"] = "mtmeetings"; 
$calendarSettings["calendarKeys"]["calendarid"] = "id"; 
$calendarSettings["calendarFields"]["calendarDateField"] = "schedule";
$calendarSettings["calendarFields"]["calendarEndDate"] = "schedule";
$calendarSettings["calendarFields"]["calendarSubject"] = "name";
//$calendarSettings["calendarFields"]["calendarCategory"] = "categoryid";
//$calendarSettings["calendarFields"]["calendarDayEvent"] = false;
$calendarSettings["calendarFields"]["calendarDescription"] = "desc";
