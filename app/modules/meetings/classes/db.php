	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "project_at_localhost" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "mtmeetings", "varname" => "project_at_localhost__mtmeetings", "altvarname" => "mtmeetings", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "mtsettings", "varname" => "project_at_localhost__mtsettings", "altvarname" => "mtsettings", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
			$dalTables[$conn->connId][] = array("name" => "mttimezone", "varname" => "project_at_localhost__mttimezone", "altvarname" => "mttimezone", "connId" => "project_at_localhost", "schema" => "", "connName" => "project at localhost");
		}
	}
