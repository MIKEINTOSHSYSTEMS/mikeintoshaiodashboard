...
//		return $this->getTableData(".showSimpleSearchOptions");
	...
	public static function getForLogin()
	{
		return !!Security::dbProvider()
			? new ProjectSettings("calusers", PAGE_LIST)
			: null;
	}
...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "mtsettings" ] = array( "url" => "mtsettings", "type" => 0 );
	$projectEntitiesReverse[ "mtsettings" ] = "mtsettings";
	$projectEntities[ "mtmeetings" ] = array( "url" => "mtmeetings", "type" => 0 );
	$projectEntitiesReverse[ "mtmeetings" ] = "mtmeetings";
	$projectEntities[ "mttimezone" ] = array( "url" => "mttimezone1", "type" => 0 );
	$projectEntitiesReverse[ "mttimezone1" ] = "mttimezone";
