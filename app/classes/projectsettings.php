...
function fillProjectEntites()
{
	...
	$projectEntities[ "cities" ] = array( "url" => "cities", "type" => 0 );
	$projectEntitiesReverse[ "cities" ] = "cities";
	$projectEntities[ "regions" ] = array( "url" => "regions", "type" => 0 );
	$projectEntitiesReverse[ "regions" ] = "regions";
	$projectEntities[ "sub_cities" ] = array( "url" => "sub_cities", "type" => 0 );
	$projectEntitiesReverse[ "sub_cities" ] = "sub_cities";
	$projectEntities[ "zones" ] = array( "url" => "zones", "type" => 0 );
	$projectEntitiesReverse[ "zones" ] = "zones";
	$projectEntities[ "dereja_services" ] = array( "url" => "dereja_services", "type" => 0 );
	$projectEntitiesReverse[ "dereja_services" ] = "dereja_services";
	$projectEntities[ "dereja_event_services" ] = array( "url" => "dereja_event_services", "type" => 0 );
	$projectEntitiesReverse[ "dereja_event_services" ] = "dereja_event_services";
	$projectEntities[ "dereja_training_services" ] = array( "url" => "dereja_training_services", "type" => 0 );
	$projectEntitiesReverse[ "dereja_training_services" ] = "dereja_training_services";
	$projectEntities[ "institution_types" ] = array( "url" => "institution_types", "type" => 0 );
	$projectEntitiesReverse[ "institution_types" ] = "institution_types";
	$projectEntities[ "departments" ] = array( "url" => "departments", "type" => 0 );
	$projectEntitiesReverse[ "departments" ] = "departments";
	$projectEntities[ "education_levels" ] = array( "url" => "education_levels", "type" => 0 );
	$projectEntitiesReverse[ "education_levels" ] = "education_levels";
	$projectEntities[ "minor_major" ] = array( "url" => "minor_major", "type" => 0 );
	$projectEntitiesReverse[ "minor_major" ] = "minor_major";
	$projectEntities[ "skills" ] = array( "url" => "skills", "type" => 0 );
	$projectEntitiesReverse[ "skills" ] = "skills";
	$projectEntities[ "dereja_information_sources" ] = array( "url" => "dereja_information_sources", "type" => 0 );
	$projectEntitiesReverse[ "dereja_information_sources" ] = "dereja_information_sources";
	$projectEntities[ "it_related_skills" ] = array( "url" => "it_related_skills", "type" => 0 );
	$projectEntitiesReverse[ "it_related_skills" ] = "it_related_skills";
	$projectEntities[ "industry_specific_skills" ] = array( "url" => "industry_specific_skills", "type" => 0 );
	$projectEntitiesReverse[ "industry_specific_skills" ] = "industry_specific_skills";
	$projectEntities[ "training_types" ] = array( "url" => "training_types", "type" => 0 );
	$projectEntitiesReverse[ "training_types" ] = "training_types";
	$projectEntities[ "professions" ] = array( "url" => "professions", "type" => 0 );
	$projectEntitiesReverse[ "professions" ] = "professions";
	$projectEntities[ "participant_organization_types" ] = array( "url" => "participant_organization_types", "type" => 0 );
	$projectEntitiesReverse[ "participant_organization_types" ] = "participant_organization_types";
	$projectEntities[ "training_venues" ] = array( "url" => "training_venues", "type" => 0 );
	$projectEntitiesReverse[ "training_venues" ] = "training_venues";
	$projectEntities[ "training_organizers" ] = array( "url" => "training_organizers", "type" => 0 );
	$projectEntitiesReverse[ "training_organizers" ] = "training_organizers";
	$projectEntities[ "training_city_towns" ] = array( "url" => "training_city_towns", "type" => 0 );
	...
	$projectEntities[ "candidates_aggrigated" ] = array( "url" => "candidates_aggrigated", "type" => 1 );
