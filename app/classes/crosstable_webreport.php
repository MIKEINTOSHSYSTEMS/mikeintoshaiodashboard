...
class CrossTableWebReport
{
	...
	{			
		...
		if("events" == $this->xml_array['tables'][0])
			$isDB = true;
		if("trainings" == $this->xml_array['tables'][0])
			$isDB = true;
		...
		if("training_participants" == $this->xml_array['tables'][0])
			$isDB = true;
		if("cities" == $this->xml_array['tables'][0])
			$isDB = true;
		if("regions" == $this->xml_array['tables'][0])
			$isDB = true;
		if("sub_cities" == $this->xml_array['tables'][0])
			$isDB = true;
		if("zones" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dereja_services" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dereja_event_services" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dereja_training_services" == $this->xml_array['tables'][0])
			$isDB = true;
		if("institution_types" == $this->xml_array['tables'][0])
			$isDB = true;
		if("departments" == $this->xml_array['tables'][0])
			$isDB = true;
		if("education_levels" == $this->xml_array['tables'][0])
			$isDB = true;
		if("minor_major" == $this->xml_array['tables'][0])
			$isDB = true;
		if("skills" == $this->xml_array['tables'][0])
			$isDB = true;
		if("dereja_information_sources" == $this->xml_array['tables'][0])
			$isDB = true;
		if("it_related_skills" == $this->xml_array['tables'][0])
			$isDB = true;
		if("industry_specific_skills" == $this->xml_array['tables'][0])
			$isDB = true;
		if("training_types" == $this->xml_array['tables'][0])
			$isDB = true;
		if("professions" == $this->xml_array['tables'][0])
			$isDB = true;
		if("participant_organization_types" == $this->xml_array['tables'][0])
			$isDB = true;
		if("training_venues" == $this->xml_array['tables'][0])
			$isDB = true;
		if("training_organizers" == $this->xml_array['tables'][0])
			$isDB = true;
		if("training_city_towns" == $this->xml_array['tables'][0])
			$isDB = true;
		if("program_areas" == $this->xml_array['tables'][0])
			$isDB = true;
		if("Candidate_Employment_Tracker" == $this->xml_array['tables'][0])
			$isDB = true;
		if("Companies" == $this->xml_array['tables'][0])
			$isDB = true;
		if("Jobs" == $this->xml_array['tables'][0])
			$isDB = true;
		if("Job_Categories" == $this->xml_array['tables'][0])
			$isDB = true;
		if("Job_Types" == $this->xml_array['tables'][0])
			$isDB = true;
		if("CompanySectors" == $this->xml_array['tables'][0])
			$isDB = true;
		if("Disability_Types" == $this->xml_array['tables'][0])
			$isDB = true;
		...
		if("webreports" == $this->xml_array['tables'][0])
			$isDB = true;
		if("webreport_style" == $this->xml_array['tables'][0])
			$isDB = true;
		if("webreport_sql" == $this->xml_array['tables'][0])
			$isDB = true;
		if("webreport_admin" == $this->xml_array['tables'][0])
			$isDB = true;
		if("webreports" == $this->xml_array['tables'][0])
			$isDB = true;
