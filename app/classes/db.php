	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "deredevatderejadevmerqconsulta" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "candidate_custom_data", "varname" => "deredevatderejadevmerqconsulta__candidate_custom_data", "altvarname" => "candidate_custom_data", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "candidate_custom_fields", "varname" => "deredevatderejadevmerqconsulta__candidate_custom_fields", "altvarname" => "candidate_custom_fields", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "dashboard_pages", "varname" => "deredevatderejadevmerqconsulta__dashboard_pages", "altvarname" => "dashboard_pages", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "dashboards", "varname" => "deredevatderejadevmerqconsulta__dashboards", "altvarname" => "dashboards", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "dereja_academy_lms", "varname" => "deredevatderejadevmerqconsulta__dereja_academy_lms", "altvarname" => "dereja_academy_lms", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "dereja_schema_fields", "varname" => "deredevatderejadevmerqconsulta__dereja_schema_fields", "altvarname" => "dereja_schema_fields", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "dereja_tables", "varname" => "deredevatderejadevmerqconsulta__dereja_tables", "altvarname" => "dereja_tables", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "derejame_audit", "varname" => "deredevatderejadevmerqconsulta__derejame_audit", "altvarname" => "derejame_audit", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "derejame_noti", "varname" => "deredevatderejadevmerqconsulta__derejame_noti", "altvarname" => "derejame_noti", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "derejame_settings", "varname" => "deredevatderejadevmerqconsulta__derejame_settings", "altvarname" => "derejame_settings", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "Employment_Status", "varname" => "deredevatderejadevmerqconsulta__Employment_Status", "altvarname" => "Employment_Status", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "faicons", "varname" => "deredevatderejadevmerqconsulta__faicons", "altvarname" => "faicons", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "indicator_targets", "varname" => "deredevatderejadevmerqconsulta__indicator_targets", "altvarname" => "indicator_targets", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "Job_Fair", "varname" => "deredevatderejadevmerqconsulta__Job_Fair", "altvarname" => "Job_Fair", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "kbarticles", "varname" => "deredevatderejadevmerqconsulta__kbarticles", "altvarname" => "kbarticles", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "kbcategories", "varname" => "deredevatderejadevmerqconsulta__kbcategories", "altvarname" => "kbcategories", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "kbcomments", "varname" => "deredevatderejadevmerqconsulta__kbcomments", "altvarname" => "kbcomments", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "kbusers", "varname" => "deredevatderejadevmerqconsulta__kbusers", "altvarname" => "kbusers", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "settings", "varname" => "deredevatderejadevmerqconsulta__settings", "altvarname" => "settings", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "deredevatderejadevmerqconsulta__users", "altvarname" => "users", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "utilities", "varname" => "deredevatderejadevmerqconsulta__utilities", "altvarname" => "utilities", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			...
			$dalTables[$conn->connId][] = array("name" => "website_data", "varname" => "deredevatderejadevmerqconsulta__website_data", "altvarname" => "website_data", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
