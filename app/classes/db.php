	...
	*/
	...
	protected static function _fillTablesList( $conn )
	{
		...
		if( "deredevatderejadevmerqconsulta" == $conn->connId )
		{
			...
			$dalTables[$conn->connId][] = array("name" => "chat_files", "varname" => "deredevatderejadevmerqconsulta__chat_files", "altvarname" => "chat_files", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "chat_groups", "varname" => "deredevatderejadevmerqconsulta__chat_groups", "altvarname" => "chat_groups", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "chat_history", "varname" => "deredevatderejadevmerqconsulta__chat_history", "altvarname" => "chat_history", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "chat_peopletype", "varname" => "deredevatderejadevmerqconsulta__chat_peopletype", "altvarname" => "chat_peopletype", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "chat_settings", "varname" => "deredevatderejadevmerqconsulta__chat_settings", "altvarname" => "chat_settings", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "chat_timezone", "varname" => "deredevatderejadevmerqconsulta__chat_timezone", "altvarname" => "chat_timezone", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
			$dalTables[$conn->connId][] = array("name" => "chat_users", "varname" => "deredevatderejadevmerqconsulta__chat_users", "altvarname" => "chat_users", "connId" => "deredevatderejadevmerqconsulta", "schema" => "", "connName" => "dere_dev at derejadev.merqcons");
