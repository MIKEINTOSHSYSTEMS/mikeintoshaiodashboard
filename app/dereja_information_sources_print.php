...
require_once("include/dereja_information_sources_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "dereja_information_sources" );
