...
require_once("include/candidates_aggrigated_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "candidates_aggrigated" );
