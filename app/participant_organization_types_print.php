...
require_once("include/participant_organization_types_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "participant_organization_types" );
