...
require_once("include/training_city_towns_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "training_city_towns" );
