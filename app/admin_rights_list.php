...
$pageMask[$table] = $mask;
$tables[$table] = array("dereja_academy_lms", " " . "Dereja Academy Lms");
$table = "Home";
$mask="";
if( pageEnabled($table, 'view') || pageEnabled($table, 'list') || pageEnabled($table, 'chart') || pageEnabled($table, 'report') || pageEnabled($table, 'dashboard') )
	$mask .= "S";
...
$pageMask[$table] = $mask;
$tables[$table] = array("performance_indicators_view", " " . "Performance Indicators View");
$table = "dereja_schema_fields";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("dereja_schema_fields", " " . "Dereja Schema Fields");
$table = "dereja_tables";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("dereja_tables", " " . "Dereja Tables");
$table = "candidate_custom_fields";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("candidate_custom_fields", " " . "Candidate Custom Fields");
$table = "candidate_custom_data";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("candidate_custom_data", " " . "Candidate Custom Data");
...
$pageMask[$table] = $mask;
$tables[$table] = array("employment_status", " " . "Employment Status");
$table = "Courses";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("categories", " " . "Categories");
$table = "Branches";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("branches", " " . "Branches");
$table = "Groups";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
...
$pageMask[$table] = $mask;
$tables[$table] = array("groups", " " . "Groups");
$table = "Course_Users_Status";
$mask="";
if( pageEnabled($table, 'add') || pageEnabled($table, 'inline_add') )
	$mask .= "A";
if( pageEnabled($table, 'edit') || pageEnabled($table, 'inline_edit') )
...
$pageMask[$table] = $mask;
$tables[$table] = array("course_users_status", " " . "Course Users Status");
