...
require_once("include/training_organizers_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "training_organizers" );
