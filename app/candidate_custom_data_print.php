...
require_once("include/candidate_custom_data_variables.php");
...
$params["selection"] = postvalue("selection"); //PrintPage::readSelectedRecordsFromRequest( "candidate_custom_data" );
