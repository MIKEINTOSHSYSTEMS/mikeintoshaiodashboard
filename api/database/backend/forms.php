...
<head>
    ...
    <title>Dereja M&E System FORMS Database Backups</title>
    ...
    <style>
        ...
        header {
            ...
            padding-top: 30px;
            min-height: 70px;
            border-bottom: #ffaa00 3px solid;
        }
        header a {
            color: #ffffff;
...
<body>
    <header>
        <div class="container">
            <h1><i class="fas fa-database"></i> Dereja M&E System FORMS Database Backups</h1>
            <ul>
