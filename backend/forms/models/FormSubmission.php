...
class FormSubmission extends ActiveRecord
{
    ...
    const EVENT_SUBMISSION_CREATED = 20; // When a submission is created with admin panel
    const EVENT_SUBMISSION_UPDATED = 21; // When a submission is updated with admin panel
