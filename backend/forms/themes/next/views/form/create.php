                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="list-group">
                                        <a href="<?= $url = Url::to(['form/update']); ?>" id="toUpdate" class="list-group-item list-group-item-action">
                                            <h4 class="list-group-item-heading"><?= Yii::t('app', 'It\'s Ok.') ?></h4>
                                            <p class="list-group-item-text text-muted">
                                                <?= Yii::t('app', 'I still want to edit this form.') ?></p></a>
                                        <a href="<?= $url = Url::to(['form/settings']); ?>" id="toSettings" class="list-group-item list-group-item-action">
                                        ...
                                        <a href="<?= $url = Url::to(['form/share']); ?>" id="toPublish" class="list-group-item list-group-item-action">
                                            <h4 class="list-group-item-heading">
                                                <?= Yii::t('app', 'Share this Form.') ?></h4>
                                            <p class="list-group-item-text text-muted">
                                                <?= Yii::t('app', 'I want to publish and share my form.') ?></p></a>
                                        <a href="<?= $url = Url::to(['form/index']); ?>" class="list-group-item list-group-item-action">
                                            <h4 class="list-group-item-heading">
