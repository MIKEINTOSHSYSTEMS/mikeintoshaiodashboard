...
class m191218_212749_upgrade_to_1_10 extends Migration
{
    ...
    public function safeUp()
    {
        ...
        $this->addColumn('{{%user}}', 'unconfirmed_email', $this->text());
        ...
        $this->addColumn('{{%profile}}', 'public_email', $this->text());
        $this->addColumn('{{%profile}}', 'gravatar_email', $this->text());
        $this->addColumn('{{%profile}}', 'gravatar_id', $this->string(32));
        $this->addColumn('{{%profile}}', 'location', $this->text());
        $this->addColumn('{{%profile}}', 'website', $this->text());
        ...
        $this->createTable(
            '{{%addon_user}}',
            [
                'addon_id' => $this->string(191)->notNull(),
                'user_id' => $this->integer(11)->notNull(),
                'created_at' => $this->integer(),
                'updated_at' => $this->integer(),
            ],
         ...
         * Form Email
         */
        $this->addColumn('{{%form_email}}', 'from_name', $this->text()->after('from'));
    ...
    public function safeDown()
    {
        ...
        $this->addColumn('{{%profile}}', 'avatar', $this->text());
        $this->addColumn('{{%profile}}', 'company', $this->text());
        ...
        $this->addColumn('{{%user}}', 'access_token', $this->text()->after('auth_key'));
