...
class m191202_174827_upgrade_to_191 extends Migration
{
    ...
    public function safeUp()
    {
        ...
        // Update Form Email
        $this->addColumn('{{%form_email}}', 'field_to', $this->text()->after('form_id'));
        ...
        // Update Form Rule
        $this->addColumn('{{%form_rule}}', 'name', $this->text()->after('form_id'));

        // Update Form Confirmation
        $this->alterColumn('{{%form_confirmation}}', 'url', $this->text());
        $this->alterColumn('{{%form_confirmation}}', 'mail_to', $this->text());
        $this->alterColumn('{{%form_confirmation}}', 'mail_from', $this->text());
        $this->alterColumn('{{%form_confirmation}}', 'mail_subject', $this->text());
        $this->alterColumn('{{%form_confirmation}}', 'mail_from_name', $this->text());
        ...
        $this->addColumn('{{%form_confirmation}}', 'mail_cc', $this->text()->after('mail_from'));
        $this->addColumn('{{%form_confirmation}}', 'mail_bcc', $this->text()->after('mail_cc'));
        ...
        $this->addColumn('{{%form_confirmation}}', 'opt_in_url', $this->text()->after('opt_in_message'));
        ...
        $this->addColumn('{{%form_confirmation}}', 'opt_out_url', $this->text()->after('opt_out_message'));
