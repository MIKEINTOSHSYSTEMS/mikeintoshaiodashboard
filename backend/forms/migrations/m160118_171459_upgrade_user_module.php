...
class m160118_171459_upgrade_user_module extends Migration
{
    public function safeUp()
    {
        ...
        $this->addColumn("{{%user_token}}", "data", Schema::TYPE_TEXT . " null after token");
    ...
    public function safeDown()
    {
        ...
        $this->addColumn("{{%user_token}}", "consume_time", Schema::TYPE_TEXT . " null");
        ...
        $this->addColumn("{{%user}}", "new_email", Schema::TYPE_TEXT . " null after email");
